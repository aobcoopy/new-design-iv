...
//                                            }
										...
										if($view=='grid')
										{
											...
											if($zz=='6' || $zz=='8' || $zz=='12')
											{
												echo '<div class="col-md-12 nopad"><div class="villa_boxs_mini- photo_banner web"><img src="/upload/search/2222.jpg" width="100%" alt="EXCURISON PROMOTION"></div></div>';
										...
										else
										{
											if($zz=='5' )
											{
												...
												echo '<div class="villa_boxs_mini col-12 nopad photo_banner mob"><img src="/upload/search/mm111.jpg" width="100%" alt="CONCIERGE OFFER"></div>';
											...
											if($zz=='6' || $zz=='12' || $zz=='18')
											{
												echo '<div class="villa_boxs_mini col-12 nopad photo_banner web "><img src="/upload/search/22222.jpg" width="100%" alt="EXCURISON PROMOTION"></div>';
