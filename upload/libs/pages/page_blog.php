        ...
        <div class="col-12">
			...
			foreach($ar_lf_hlotm as $hl_of_tm)
			{
				echo '<div class="item hlotm_sl_box" data-hash="'.$c.'">';
					echo '<img src="'.imagePath($hl_of_tm['photo']).'" alt="">';
						...
						if(($x%2)==0)
						{
							...
							<div class="col-6">
								...
								<div class="lsarti_l_box">
									<img src="<?php echo imagePath($blog_1['img_photo_high']);?>" width="100%" class="ls_left_box" alt="">
											...
											<div class="row">
												...
												<div class="col-6 ">
													<div class="lsarti_ins_box">
														<img src="<?php echo imagePath($b_all['photo_mail']);?>" width="100%" class="ls_arti_photo" alt="">
