...
while($line = $dbc->Fetch($sql_des))
{
	...
	$sql = "SELECT 
			...
			FROM
				properties AS p
			WHERE
				p.pro_status > 0 and p.destination = '".$line['id']."'
			ORDER BY
				p.destination ASC
			";
	$qry = $dbc->Query($sql);
	...
	if($count>0)
	{
		...
		while($row = $dbc->Fetch($qry))
		{
			...
			echo '<div class="col-12 col-sm-12 col-md-6 col-lg-4 col-xl-4 '.$pading_grid.' ">';//<a href="?page=blogdetail&blog='.$r_blog['id'].'">
					...
					echo '<div class="col-xs-12 col-sm-12 col-md-12 boxbot_b nopad">';
							
						echo '<div class="col-xs-12 col-sm-12 col-md-12  borbo nopad">';
						echo '<div class="row" style="margin-left: 0px;">';
							echo '<div class="col-12 col-sm-12 col-md-12 col-lg-8 col-xl-9 t_t33 nopad">';
								if(strlen($name[0])>20)
								{
							...
							echo '</div>';
							echo '<div class="col-sm-12 col-md-12 col-lg-4 col-xl-3 t_t44 web9922 nopad text-right revv" style="font-size:13px;margin-top: 22px;padding-right: 15px;">';
						...
						echo '<div class="col-xs-12 col-sm-12 col-md-12 nopad">';
							...
							echo '<div class="row">';
							echo '<div class="col-6 col-sm-6 col-lg-6 col-xl-6 nopad t_t22" style="font-size: 14px;padding-left:15px;">';
							...
							echo '<div class="col-6 col-sm-6 col-lg-6 col-xl-6 nopad t_t11" style="font-size: 14px;">';
							...
							echo '<div class="col-12 col-sm-12 col-lg-12 col-xl-12 nopad web9922 t_t22 t_t23 text-right1">';
								
								echo '<div class="row">';
								echo '<div class="col-7 col-sm-7 col-lg-7 col-xl-7 pritop t_t22" style="padding-left: 25px;padding-bottom: 10px;">';
								...
								echo '<div class="col-5 col-sm-5 col-lg-5 col-xl-5 nopads t_t3s">';	
									echo '<a href="/'.$row['ht_link'].'.html" target="_blank"><button class="probut2">View Details</button></a>';
								echo '</div>';
								echo '</div>';
