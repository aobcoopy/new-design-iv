...
<div class=" mg-room-fecilities padl50 ">
    <div class="mg-single-room-txt  cenb  web" id="style-3" style="margin-top:0px; ">
        <div id="enbox"  class="enbox_xy">
            <div id="enbox2"  class="col12 enbox box   ">
                ...
                <form id="form_contact_website" class="clearfix">
                    ...
                    <div class="mg-contact-form-input col-sm-6 col-md-6 nopad" style="padding-right:2px;">
                    ...
                    <div class="mg-contact-form-input col-sm-6 col-md-6 nopad" style="padding-left:2px;"><!-- -->
