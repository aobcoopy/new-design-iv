                            ...
                            <div class="row">
                                <div class="col-md-3 col-sm-12 col-xs-12"> 
                                        <select id="cbbDestination" name="cbbDestination" onChange="load_subdestination(this);" class="cbbdes2 cs-select cs-skin-elastic cbbo">
                                            <option value="all"  <?php echo isset($_REQUEST['des'])?'':'selected';?>>Thailand </option>
                                            <?php 
...
<!--                    
                    <div class="col-md-4 col-xs-4 col-sm-4 ">
                        <select name="cbbActualbed" id="cbbActualbed" class="pull-right form-control cbbox ontop"></select>
                    </div>
-->                    
                    <div class="col-md-6 col-xs-6 col-sm-6 ">
