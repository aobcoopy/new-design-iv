...
{
	$alink = '<li class=""><a class="tb" href="/search-rent/thailand/'.beach_footer($abn['id']).'/all-price/all-bedrooms/'.collection_footer($acn['id']).'/all-sort.html" >'.$acn['name'].' Thailand Villas</a></li>';
...
foreach($arr_beach_name_12 as $abn)
{
	foreach($arr_coll_name_re as $acn)
	{
		if($_REQUEST['cate']==$acn['id'])
		{
			if($abn['parent']=='')
			{
				$alink = '<li class=""><a class="tb" href="/search-rent/'.destination_footer($abn['id']).'/'.beach_footer($abn['id']).'/all-price/'.bed_footer(0).'/'.collection_footer($acn['id']).'/all-sort.html" >'.$acn['name'].' '.$abn['name'].' Villas '.destination_name(0).'</a></li>';
				if(!in_array($alink,$arr_link_12))
				{
			...
			{
				$alink = '<li class=""><a class="tb" href="/search-rent/'.destination_footer($abn['parent']).'/'.beach_footer($abn['id']).'/all-price/'.bed_footer(0).'/'.collection_footer($acn['id']).'/all-sort.html" >'.$acn['name'].' '.$abn['name'].' Villas '.destination_name($abn['parent']).'</a></li>';
				if(!in_array($alink,$arr_link_12))
				{
...
$alink = '<li class=""><a class="tb" href="/search-rent/'.destination_footer(38).'/'.beach_footer(0).'/all-price/'.bed_footer(0).'/'.collection_footer($_REQUEST['cate']).'/all-sort.html" >'.collection_footer_name($_REQUEST['cate']).' '.destination_name(38).' Villas</a></li>';
if(!in_array($alink,$arr_link_12))
{
...
$alink = '<li class=""><a class="tb" href="/search-rent/'.destination_footer(39).'/'.beach_footer(0).'/all-price/'.bed_footer(0).'/'.collection_footer($_REQUEST['cate']).'/all-sort.html" >'.collection_footer_name($_REQUEST['cate']).' '.destination_name(39).' Villas</a></li>';
if(!in_array($alink,$arr_link_12))
{
...
{
	$alink = '<li class=""><a class="tb" href="/search-rent/thailand/'.beach_footer($abn['id']).'/all-price/'.bed_footer($abed['id']).'/all-collections/all-sort.html" >'.$abed['name'].' Thailand Villas</a></li>';
