...
$photo_cover = imageP($photo_cover);
?>
<style>  
.mg-page-title {
    padding-top: 0px;
...
<div class="mg-page-titles top68d" style="    margin-top: 48px;"><!--parallax-->
...
<?php //include "libs/pages/dt_facebook_comment.php";?>
<br>
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <div class="col-md-12 nopad bline">
                	<div class="col-md-12 nopad titleb"><div class="dot "></div><div class="dot ft"></div>Booking Process</div>
                    <div class="col-md-12 ">
                    	<div class="detai" style="font-family: pt !important;">
