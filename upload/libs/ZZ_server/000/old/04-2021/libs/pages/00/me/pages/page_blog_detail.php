            ...
            <div class="col-md-8">
                <main>
                    ...
                    <article class="mg-post">
                        <header>
                            <a href="#"><img src="<?php echo $photo[0];?>" alt="<?php echo $blogs['name'];?>" class="img-responsive"></a>
                            ...
                            <div class="mg-post-meta">
                                ...
                                <div class="webb">
                                	 <ul class="mg-footer-social btnn pull-right">
                                        ...
                                        <li data-toggle="tooltip" data-placement="bottom" title="Share" onclick="gPlus('<?php echo urlencode($Urllink);?>');"><a ><i class="fa fa-google-plus tw"></i></a></li>
