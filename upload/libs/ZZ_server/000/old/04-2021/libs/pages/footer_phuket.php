...
?>
 <div class="container <?php echo $show_phuket.' '.$f_foot;?>">
		...
		if($_REQUEST['cate']!=6)
		{
				...
				{
					?>
                    <h2 class=" mb f30 top"><strong><?php /* ?><a class="tg cdf" ><?php */?>Where are the Best 5,6,7 Bedroom Villas in Phuket?<?php /*?></a><?php */?></strong></h2>
				...
				elseif($_SERVER['REQUEST_URI']=='/search-rent/thailand-phuket/all-beach/all-price/8-10-bedrooms/all-collections/all-sort.html')
				{
					...
					?>
                    <h2 class=" mb f30 top"><strong><?php /* ?><a class="tg cdf" ><?php */?>Where are the Best 8,9,10> Bedroom Villas in Phuket?<?php /*?></a><?php */?></strong></h2>
                    <div class="col-md-12 nopad top41">
                        <table class="table table-bordered table-striped ttb" width="100%%" border="1">
                            <thead>
                                <tr>
		...
		else
		{
			...
			?>
			 <h2 class=" mb f30 top"><strong><?php /*?><a class="tg cdf" ><?php */?>Where are the Best Beachfront Villas in Phuket?<?php /*?></a><?php */?></strong></h2>
            ...
            <br><br>
			 ...
			 <h2 class=" mb f30"><strong><?php /*?><a class="tg cdf" ><?php */?>Luxury Beachfront Villas in Phuket <?php /*?></a><?php */?></strong></h2>
...
//			  '/search-rent/thailand-phuket/all-beach/all-price/8-10-bedrooms/all-collections/all-sort.html'
		...
		if($_REQUEST['cate']!=6)
		{
			...
			$link_url_mkt = $_SERVER['REQUEST_URI'];
			  ...
			  else
			  {
				  ?>
                  <div class="col-md-12 nopad top41">
                    <h4 class=" mb f30 top"><strong>Phuket Luxury Villas </strong></h4><?php /*?>Phuket Luxury Villas<?php */?>
                        <p class="col-md-12 nopad top21 f18 pnone">
        ...
        <?php /*?><div class="col-md-12 nopad top10">
            <p class="col-md-12 nopad top21 f18 pnone">
...
So all you have to do is choose the number of bedrooms you need below and you will see all the villas available to your group.
        ...
        <div class="col-md-12 nopad top41">
        <h4 class=" mb f22 top"><a class="blu" href="/search-rent/thailand-phuket/all-beach/all-price/1-4-bedrooms/all-collections/all-sort.html">Phuket villas with 2,3,4 bedrooms</a></h4>
            <p class="col-md-12 nopad top21 f18 ">
                These villas make for a great family villa holiday in Phuket.
            </p>
            <p class="col-md-12 nopad top21 f18 ">
                The most common category is <a class="blu" href="/search-rent/thailand-phuket/all-beach/all-price/5-7-bedrooms/all-collections/all-sort.html" >5,6,7 bedroom villas Phuket</a> offering the largest flexibility in group numbers. Remember that these villas may allow you to use less bedrooms and pay less too. Nearly all have a cinema, games and fitness room.
            </p>
        </div>
        
        <div class="col-md-12 nopad top41">
        <h4 class=" mb f22 top"><a class="blu" href="/search-rent/thailand-phuket/all-beach/all-price/8-10-bedrooms/all-collections/all-sort.html">8,9,10 > bedroom villas Phuket</a></h4>
            <p class="col-md-12 nopad top21 f18 pnone">
		...
		if($_REQUEST['room']=='all')
		{
			if($_REQUEST['cate']!=6)
			{
				?>
				<div class="col-md-12 nopad top41">
                <h4 class=" mb f22 top"><strong>Villas with full-time chef</strong></h4>
                    <p class="col-md-12 nopad top21 f18 pnone">
		...
		?>
        <div class="col-md-12 nopad top41">
        <h4 class=" mb f30 top"><strong>What type of Villas are for rent</strong></h4> <?php /*?>What type of Phuket Luxury Villas are for rent<?php */?>
            <p class="col-md-12 nopad top21 f18 ">
        ...
        <div class="col-md-12 nopad  f18">
			...
			if($_SERVER['REQUEST_URI']=='/search-rent/thailand-phuket/all-beach/all-price/all-bedrooms/all-collections/all-sort.html')
			{
                ...
                2.  <a class="blu" href="/search-rent/thailand-phuket/all-beach/all-price/all-bedrooms/beachfront-villas/all-sort.html">Phuket beachfront villas</a> offer direct access to enjoy the sea and beach surrounds. Unlike <a href="/search-rent/thailand-koh-samui/all-beach/all-price/all-bedrooms/all-collections/all-sort.html" class="blu">Koh Samui</a> there are not many of these beach villas in Phuket and so forward planning is needed to secure availability.
            </p>
			<?php
			}
			else
...
There are many large beautiful properties that can be the wedding villa for your special day.We can liaise with wedding planners to make sure all goes to plan.
         ...
         <?php 
			if($_REQUEST['cate']!=6)
			{
                ...
                <div class="col-md-12 nopad top41">
				<h4 class=" mb f30 top"><strong>2020 Villa Cost Survey</strong></h4>
				</div>
				
				<div class="col-md-12 nopad top41">
				<?php /*?><h4 class=" mb f22 top"><strong><a class="tg cdf" >Luxury Villas Phuket Cost </a></strong></h4><?php */?>
					<p class="col-md-12 nopad top21 f18 pnone">
						As the Villa marketing company with the widest choice of luxury villas in Phuket we have analysed our 2019 data.<br>

                        This has enabled us to release this up-to-date survey of the average cost of renting a villa in Phuket to give a guide for 2020.<br>
                        ...
                        For our many Australian customers this exchanges to AUD$165 as of December 2019
					</p>
				</div>
                ...
                <div class="col-md-12 nopad top41">
				<h4 class=" mb f22 top"><strong><?php /* ?><a class="tg cdf" ><?php */?>1. Do villas require a minimum number of nights booking?<?php /*?></a><?php */?></strong></h4>
					<p class="col-md-12 nopad top21 f18">
...
This is typically 3 nights throughout the year although in high season this can increase to 5 or 7, and even 10 nights in peak season. At the bottom of our villa details pages we show the minimum nights required at the different times of the year.
                ...
                <div class="col-md-12 nopad top41">
				<h4 class=" mb f22 top"><strong><?php /* ?><a class="tg cdf" ><?php */?>4. Can I rent a specific number of bedrooms?<?php /*?></a><?php */?></strong></h4>
					<p class="col-md-12 nopad top21 f18">
...
And you still get to use the entire villa and its facilities plus the service of all the staff.
                ...
                <div class="col-md-12 nopad top41">
				<h4 class=" mb f22 top"><strong><?php /* ?><a class="tg cdf" ><?php */?>5. Are children allowed?<?php /*?></a><?php */?></strong></h4>
					<p class="col-md-12 nopad top21 f18">
...
lovely outdoor areas & pool decks. Every group profile is different so please contact us by inquiring on the villa that interests you most and we will provide you a list of all the available villas that have a bedroom configuration that works best for your group and requirements.
                ...
                <div class="col-md-12 nopad top41">
				<h4 class=" mb f22 top"><strong><?php /* ?><a class="tg cdf" ><?php */?>6. How do I organize group excursions & transport?<?php /*?></a><?php */?></strong></h4>
					<p class="col-md-12 nopad top21 f18">
...
We are here to make your luxury villa holiday in Phuket as convenient and easy as possible.
                ...
                <div class="col-md-12 nopad top41">
				<h4 class=" mb f22 top"><strong><?php /* ?><a class="tg cdf" ><?php */?>7. How far in advance can i book?<?php /*?></a><?php */?></strong></h4>
					<p class="col-md-12 nopad top21 f18">
...
Planning and booking well in advance will give you the most villas to choose from.
        ...
        <div class="col-md-12 nopad top41">
        <h4 class=" mb f30 top"><strong><?php /* ?><a class="tg cdf" ><?php */?>2019 Phuket Beachfront Villa Cost Survey<?php /*?></a><?php */?></strong></h4>
            <div class="col-md-12 nopad top21 f18">
        ...
        <div class="col-md-12 nopad top41">
        <h4 class=" mb f22 top"><strong><?php /* ?><a class="tg cdf" ><?php */?>1. Where can I find the best villas on the beach in Phuket<?php /*?></a><?php */?></strong></h4>
            <div class="col-md-12 nopad top21 f18">
...
The social spaces indoors flow into each other to create one big communal floor in the villa overlooking the Andaman sea. Sleeps up to 16 guests.
                    ...
                    <div   class="col-md-12 nopad top21">
                    <h4 class=" mb f22 top"><strong><a class="tg cdf" >2. <a href="/luxury-villas/villa-yin-yang/kamala-beach-phuket-thailand.html" class="blu"><span >Villa Yin & Villa Yang</span></a> <span class="tg">in Kamala</span></a></strong></h4>
                        <div class="col-md-12 nopad top21 f18">
                    ...
                    <div   class="col-md-12 nopad top21">
                    <h4 class=" mb f22 top"><strong><a class="tg cdf" >3. <a href="/luxury-villas/villa-sawarin/cape-yamu-phuket-thailand.html" class="blu"><span >Villa Sawarin</span></a> <span class="tg">in Cape Yamu</span></a></strong></h4>
                        <div class="col-md-12 nopad top21 f18">
                    ...
                    <div   class="col-md-12 nopad top21">
                    <h4 class=" mb f22 top"><strong><a class="tg cdf" >4. <a href="/luxury-villas/villa-thousand-hills/nai-harn-phuket-thailand.html" class="blu"><span >Villa Thousand Hills</span></a> <span class="tg">in Nai Harn</span></a></strong></h4>
                        <div class="col-md-12 nopad top21 f18">
...
Sleeps 22 guests.
                    ...
                    <div   class="col-md-12 nopad top21">
                    <h4 class=" mb f22 top"><strong><a class="tg cdf" >5. <a href="/luxury-villas/villa-beyond-namaste/bangtao-beach-phuket-thailand.html" class="blu"><span >Villa Beyond Namaste</span></a> <span class="tg">in Bangtao</span></a></strong></h4>
                        <div class="col-md-12 nopad top21 f18">
                   ...
                   <?php /*?> <div   class="col-md-12 nopad top21">
                    <h4 class=" mb f22 top"><strong><a class="tg cdf" >6. <a href="/luxury-villas/vertigo-villa-amonteera/surin-phuket-thailand.html" class="blu"><span >Villa Amonteera</span></a> <span class="tg">in Surin</span></a></strong></h4>
                        <div class="col-md-12 nopad top21 f18">
                    ...
                    <?php /*?><div   class="col-md-12 nopad top21">
                    <h4 class=" mb f22 top"><strong><a class="tg cdf" >6. <a href="/luxury-villas/vertigo-villa-zavier/surin-phuket-thailand.html" class="blu"><span >Villa Zavier</span></a> <span class="tg">in Surin</span></a></strong></h4>
                        <div class="col-md-12 nopad top21 f18">
                    ...
                    <div   class="col-md-12 nopad top21">
                    <h4 class=" mb f22 top"><strong><a class="tg cdf" >7. <a href="/luxury-villas/villa-baan-amandeha/ao-yon-bay-phuket-thailand.html" class="blu"><span >Villa Baan Amandeha</span></a> <span class="tg">in Ao Yon</span></a></strong></h4>
                        <div class="col-md-12 nopad top21 f18">
		...
		?>
        <div class="col-md-12 nopad top41">
        <h4 class=" mb f30 top"><strong><?php /* ?><a class="tg cdf" ><?php */?>How can I find the best villas in Phuket<?php /*?></a><?php */?></strong></h4> <?php /*?>How can I find the best luxury villas in Phuket<?php */?>
            <div class="col-md-12 nopad top21 f18">
...
Just get ready to have the best time on your next holiday.<?php */?>
        ...
        <div class="col-md-12 nopad top41">
        <h4 class=" mb f30 top"><strong><?php /* ?><a class="tg cdf" ><?php */?>Where can i find a place to search all of the villas for rent <?php /*?></a><?php */?></strong></h4>
            <div class="col-md-12 nopad top21 f18">
...
This will save you lots of time and research as we will only present the villas for rent that suit and are available.
		...
		?>
        <div   class="col-md-12 nopad top41">
        <h4 class=" mb f22 "><?php /* ?><a class="tg cdf" ><?php */?>1. <a class="blu" href="/search-rent/thailand-phuket/kamala-beach/all-price/all-bedrooms/all-collections/all-sort.html"><span >Kamala Villas</span></a><?php /*?></a><?php */?></h4>
            <div  class="col-md-12 nopad top21 f18">
        ...
        <h4 class=" mb f22 top"><?php /* ?><a class="tg cdf" ><?php */?>2. <a class="blu" href="/search-rent/thailand-phuket/layan-beach/all-price/all-bedrooms/all-collections/all-sort.html"><span >Layan Villas</span></a><?php /*?></a><?php */?></h4>
        ...
        <div   class="col-md-12 nopad top21">
        <h4 class=" mb f22 top"><?php /* ?><a class="tg cdf" ><?php */?>3. <a class="blu" href="/search-rent/thailand-phuket/surin-beach/all-price/all-bedrooms/all-collections/all-sort.html"><span >Surin Villas</span></a><?php /*?></a><?php */?></h4>
            <div  class="col-md-12 nopad top21 f18">
...
Possibly one of the most private villas in Phuket, explore 9 bedroom Villa Thousand Hills which sleeps up to 22.
        ...
        <div   class="col-md-12 nopad top21">
        <h4 class=" mb f22 top"><?php /* ?><a class="tg cdf" ><?php */?>5. <a class="blu" href="/search-rent/thailand-phuket/ao-yon-bay/all-price/all-bedrooms/all-collections/all-sort.html"><span >Ao Yon Villas</span></a><?php /*?></a><?php */?></h4>
            <div  class="col-md-12 nopad top21 f18">
        ...
        <div   class="col-md-12 nopad top21">
        <h4 class=" mb f22 top"><?php /* ?><a class="tg cdf" ><?php */?>6. <a class="blu" href="/search-rent/thailand-phuket/cape-yamu/all-price/all-bedrooms/all-collections/all-sort.html"><span >Cape Yamu Villas</span></a><?php /*?></a><?php */?></h4>
            <div  class="col-md-12 nopad top21 f18">
		...
		else
		{
			?>
            <?php /*?><div   class="col-md-12 nopad top41">
        <h4 class=" mb f22 "><strong><a class="tg cdf" >1. <a class="blu" href="/search-rent/thailand-phuket/kamala-beach/all-price/all-bedrooms/all-collections/all-sort.html"><span >Kamala Villas</span></a></a></strong></h4>
            <div  class="col-md-12 nopad top21 f18">
                A popular destination with beach dining and shopping and not far from the main entertainment district Patong. The newly opened Cafe Del Mar beach club is located here. Kamala’s luxury villas are nestled in the hills above the beach.
            </div>
        </div>
...
Possibly one of the most private beachfront villas in Phuket, explore 9 bedroom Villa Thousand Hills which sleeps up to 22.
        ...
        <div   class="col-md-12 nopad top21">
        <h4 class=" mb f22 top"><strong><a class="tg cdf" >3. <a class="blu" href="/search-rent/thailand-phuket/ao-yon-bay/all-price/all-bedrooms/all-collections/all-sort.html"><span >Ao Yon Villas</span></a></a></strong></h4>
            <div  class="col-md-12 nopad top21 f18">
                A piece of old Thailand in this secluded & quiet bay in Phuket's south. There are only a few villas here but possibly the best on the island.
        ...
        <div   class="col-md-12 nopad top21">
        <h4 class=" mb f22 top"><strong><a class="tg cdf" >4. <a class="blu" href="/search-rent/thailand-phuket/cape-yamu/all-price/all-bedrooms/all-collections/all-sort.html"><span >Cape Yamu Villas</span></a></a></strong></h4>
            <div  class="col-md-12 nopad top21 f18">
