...
if(isset($_SESSION['auth']['user_id']))
{
	...
	function view_form()
	{
		window.location = '/view-villaform-<?php echo $id;?>.html';
	}
	</script>
	<?php
}
...
<div class="container back_form">
    ...
    <input type="hidden" name="txtID" value="<?php echo $form_id;?>">  
        <div class="col-md-12 nopad top15">
            ...
            <dl class="dl-horizontal top15">
              ...
              <dt>Address</dt> <dd><textarea name="tx_in_address" id="tx_in_address" style="width:100%;" placeholder="24/27, Soi Naya, Tambon Rawai, Amphoe Mueang Phuket, Chang Wat Phuket 83100"><?php echo $inf['address'];?></textarea></dd>
              <dt>Location</dt> <dd><input type="text" name="tx_in_location" id="tx_in_location" placeholder="Naiharn Beach, Phuket"  style="width:100%;" value="<?php echo $inf['location'];?>"></dd>
              <dt>Telephone</dt> <dd><input type="text" name="tx_in_phone" id="tx_in_phone" placeholder="+66 (0) 84 677 1551"  style="width:100%;" value="<?php echo $inf['phone'];?>"></dd>
    ...
    <input type="hidden" name="txtID" value="<?php echo $form_id;?>">     
        <div class="col-md-12 nopad top15">
            ...
            <p class="top15"><input type="text" name="tx_ser_hour" id="tx_ser_hour" placeholder="The service hours at the villa are from 07:00 – 22:00."  style="width:100%;" value="<?php echo $form['services'];?>"></p>
    ...
    <input type="hidden" name="txtID" value="<?php echo $form_id;?>">      
        <div class="col-md-12 nopad top15">
            ...
            <p class="top15"><input type="text" name="tx_onsite" id="tx_onsite" placeholder="Villa Manager:	Ms. Kaew +66 97 002 9208"  style="width:100%;" value="<?php echo $form['onsite_con'];?>"></p>
    ...
    <input type="hidden" name="txtID" value="<?php echo $form_id;?>">
        <div class="col-md-12 nopad top15">
        	...
        	<div class="vf_title vt_undl">4) ARRIVAL AND DEPARTURE TIMES 
        ...
        <div class="col-md-12 nopad top15">
            ...
            <p class="top15 vf_title_sub"><input type="text" name="tx_air_transfer" id="tx_air_transfer" placeholder="You have round-trip complimentary airport transfer 2 van maximum each trip. (same flight only)."  style="width:100%;" value="<?php echo $arrival['transfer'];?>"></p>
        </div>
    ...
    <input type="hidden" name="txtID" value="<?php echo $form_id;?>">
        <div class="col-md-12 nopad top15">
            ...
            <div class="col-md-12 nopad "><input type="tel" name="tx_phone" id="tx_phone" style="width:100%" value="<?php echo $form['phone'];?>"></div>
            <br><p><br>
	...
	{
		var x='';
		x+= '<div class="col-md-12 nopad top10">';
    ...
    <input type="hidden" name="txtID" value="<?php echo $form_id;?>">
    	<div class="col-md-12 nopad top15">
            ...
            <div class="vf_title_sub">
            <div class="col-md-12 nopad "><textarea name="tx_BREAKFAST" id="tx_BREAKFAST" cols="30" rows="5" style="width:100%"><?php echo $form['breakfast'];?></textarea></div>
            <p>
    ...
    <input type="hidden" name="txtID" value="<?php echo $form_id;?>">
    	<div class="col-md-12 nopad top15">
            ...
            <div class="vf_title_sub">
            <div class="col-md-12 nopad "><textarea name="tx_special" id="tx_special" cols="30" rows="5" style="width:100%"><?php echo $form['dietary'];?></textarea></div>
    ...
    <input type="hidden" name="txtID" value="<?php echo $form_id;?>">
        ...
        <div class="col-md-12 nopad top15">
            ...
            <p class="top15 vf_title_sub">The refundable security deposit <input class="" type="text" name="tx_deposit" id="tx_deposit" placeholder="of US$1500 " value="<?php echo $form['deposit'];?>"> <button type="button" class="btn btn-primary " onClick="save_deposit();"> Save</button>
            <span class="icon">
