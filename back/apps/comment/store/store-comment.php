<?php
	...
	$sTable = "rating AS r 
	LEFT JOIN properties AS p ON r.property = p.id
	...
	if ( $_REQUEST['search']['value'] != "" ){
		$sWhere = "WHERE r.cus_status IS NOT NULL AND (";//---------where option
	...
	{
		$sWhere .="WHERE r.cus_status IS NOT NULL";//---------where option
	}
