...
var edit = {
	change_status:function(id){
		$.ajax({
				url: "apps/yacth_prefer_time/xhr/action-change-status.php",
				type: "POST",
				dataType:"json",
				data: {id:id},
	...
	change_v_status:function(id){
		$.ajax({
				url: "apps/yacth_prefer_time/xhr/action-change-v_status.php",
				type: "POST",
				dataType:"json",
				data: {id:id},
				success : function(response)
...
$.extend(fn.app,{yacth_prefer_time:yacth_prefer_time,edit:edit});