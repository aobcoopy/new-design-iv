<?php
	include_once "apps/yacth_prefer_time/view/dialog.yacth_prefer_time.remove.php";
?>
<script style="text/javascript">
	
	fn.app.yacth_prefer_time.yacth_prefer_time.remove = function(){
	...
	$("#btnRemoveGroup").click(function(){
		fn.app.yacth_prefer_time.yacth_prefer_time.remove();
	});
	...
	$("#dialog_remove_group .btnConfirm").click(function(){
		var item_selected = $("#tblSlide").data("selected");
		$.post('apps/yacth_prefer_time/xhr/action-remove-yacth_prefer_time.php',{items:item_selected},function(response){
