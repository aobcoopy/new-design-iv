<?php
	include_once "apps/destination/view/dialog.destination.remove.php";
?>
<script style="text/javascript">
	
	fn.app.destination.destination.remove = function(){
	...
	$("#btnRemoveGroup").click(function(){
		fn.app.destination.destination.remove();
	});
	...
	$("#dialog_remove_group .btnConfirm").click(function(){
		var item_selected = $("#tblSlide").data("selected");
		$.post('apps/destination/xhr/action-remove-destination.php',{items:item_selected},function(response){
