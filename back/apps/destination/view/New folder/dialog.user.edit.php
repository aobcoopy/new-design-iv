...
?>
<div class="modal fade" id="dialog_edit_user" data-backdrop="static">
  	<div class="modal-dialog">
		<form id="form_edituser" class="form-horizontal" role="form" onsubmit="fn.app.accctrl.user.save_change();return false;">
