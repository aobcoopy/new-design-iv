...
<div class="modal fade" id="dialog_edit_group" data-backdrop="static">
  	<div class="modal-dialog">
		<form id="form_edit_destination" class="form-horizontal" role="form" onsubmit="fn.app.destination.destination.save_change_email();return false;">
    	...
    	<div class="modal-content">
		    ...
		    <div class="modal-body">
                <div class="form-group">
                    <label for="txtSlug" class="col-sm-2 control-label">Email</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="txEmail_edit" name="txEmail_edit" value="<?php echo $destination['email'];?>">
                    </div>
                </div>
