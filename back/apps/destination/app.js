...
var edit = {
	change_status:function(id,me,vale){
		...
		{
			$.ajax({
				url: "apps/destination/xhr/action-change-status.php",
				type: "POST",
				dataType:"json",
				data: {id:id},
				...
				{$("#tblSlide").DataTable().draw();
					if(response.success==true){
						...
						$.ajax({
							//url: "https://www.inspiringvillas.com/libs/action_notifications/alert_destination_status_on_off.php",
							url: "../../libs/action_notifications/alert_destination_status_on_off.php",
							type: "POST",
							data: {
...
$.extend(fn.app,{destination:destination,edit:edit});