<div class="modal fade" id="dialog_add_yacth_marina" data-backdrop="static">
  	<div class="modal-dialog">
		<form id="form_add_yacth_marina" class="form-horizontal" role="form" onsubmit="fn.app.yacth_marina.yacth_marina.add();return false;">
...
<?php /*?>        <form id="form_add_photo" class="hidden">
            ...
            <button type="button" id="btn_upp" onClick="fn.app.yacth_marina.yacth_marina.upload_photo_file()">UP</button>
        </form>
        <form id="form_add_photo_cover" class="hidden">
            <!--<input name="txtID" value="<?php echo $brand['id']?>" type="hidden">-->
            <input id="f_Photo_cover" name="file" type="file">
            <button type="button" id="btn_upp_cover" onClick="fn.app.yacth_marina.yacth_marina.upload_photo_file_cover()">UP</button>
        </form>
<?php */?>        
