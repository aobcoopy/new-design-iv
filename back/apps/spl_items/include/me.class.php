...
class meClass{
	...
	private $header_meta = array(
		array('spl_items'	,"Product items",	'fa fa-group'),
	...
	function PageHeader($active){
		echo '<div id="breadcrumb">';
			echo '<ul class="breadcrumb push-down-0">';
				echo ' <li><a href="?app='.$this->app.'"> Shopping List</a></li>';
				echo ' <li><a href="?app='.$this->app.'"> Product items</a></li>';
