    ...
    else
    {
        ...
        echo '<div class="panel panel-'.$color.'">';
            echo '<div class="panel-heading" role="tab" id="headingOne">';
				...
				echo '<br><button type="button" class="btn btn-danger pull-right" onClick="fn.app.transfer.reverse(this,'.$row['idp'].');">Reverse</button>';
				if($total_data>0)
				{
...
if($z==0)
{
	echo '<div class="alert alert-warning" role="alert"><i class="fa fa-exclamation-circle" aria-hidden="true"></i> No data</div>';
}
//print_r($ar_id);
?>
<form id="form_ar">
