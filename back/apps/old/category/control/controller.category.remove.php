<?php
	include_once "apps/category/view/dialog.category.remove.php";
?>
<script style="text/javascript">
	
	fn.app.category.category.remove = function(){
	...
	$("#btnRemoveGroup").click(function(){
		fn.app.category.category.remove();
	});
	...
	$("#dialog_remove_group .btnConfirm").click(function(){
		var item_selected = $("#tblGroup").data("selected");
		$.post('apps/category/xhr/action-remove-category.php',{items:item_selected},function(response){
