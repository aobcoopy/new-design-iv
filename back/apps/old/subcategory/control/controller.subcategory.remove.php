<?php
	include_once "apps/subcategory/view/dialog.subcategory.remove.php";
?>
<script style="text/javascript">
	
	fn.app.subcategory.subcategory.remove = function(){
	...
	$("#btnRemoveGroup").click(function(){
		fn.app.subcategory.subcategory.remove();
	});
	...
	$("#dialog_remove_group .btnConfirm").click(function(){
		var item_selected = $("#tblGroup").data("selected");
		$.post('apps/subcategory/xhr/action-remove-subcategory.php',{items:item_selected},function(response){
