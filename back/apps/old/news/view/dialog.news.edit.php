...
<?php
	...
	$news = $dbc->GetRecord("news","*","id=".$_REQUEST['id']);
	$photo = json_decode($news['photo'],true);
?>
<div class="modal fade" id="dialog_edit_group" data-backdrop="static">
  	<div class="modal-dialog">
		<form id="form_editgroup" class="form-horizontal" role="form" onsubmit="fn.app.news.news.save_change();return false;">
		<input type="hidden" name="txtID" value="<?php echo $news['id'];?>">
    	<div class="modal-content">
		    ...
		    <div class="modal-body">
            	<div class="form-group">
					...
					<div class="col-sm-10">
						<input type="text" class="form-control" id="txtName_edit" name="txtName_edit" maxlength="50" value="<?php echo $news['name'];?>" placeholder="Name">
					</div>
				</div>
                <div class="form-group">
					<label for="txtName" class="col-sm-2 control-label">Title</label>
					<div class="col-sm-10">
						<input type="text" class="form-control" id="txtTitle_edit" name="txtTitle_edit" maxlength="50" value="<?php echo $news['title'];?>" placeholder="Title">
					</div>
				</div>
                <div class="form-group">
					<label for="txtName" class="col-sm-2 control-label">Brief</label>
					<div class="col-sm-10">
						<input type="text" class="form-control" id="txtBrief_edit" name="txtBrief_edit" maxlength="313" value="<?php echo $news['brief'];?>" placeholder="Brief">
					</div>
				</div>
                <div class="form-group">
					<label for="txtName" class="col-sm-2 control-label">Detail</label>
					<div class="col-sm-10">
						<textarea type="text" class="form-control" id="txtDetail_edit" name="txtDetail_edit"  placeholder="Detail"><?php echo $news['detail'];?></textarea>
					</div>
				</div>
                <div class="form-group">
                ...
                <div class="my_phot">
					...
					$imgg = json_decode($news['images'],true);
					if($imgg!='')
					foreach($imgg as $im)
					{
						echo '<div class="col-md-6  addedPic" >';
							echo '<img  src="'.$im.'"  width="150" class="image_photos">';
							echo '<input type="hidden" class="form-control vals" value="'.$im.'"  name="t_photo[]">';
							echo '&nbsp; <button type="button" class="btn btn-xs btn-danger"  onClick="unlink_me(this)">Remove</button>';
						echo '</div>';
					}
					?>
                </div>
        ...
        <form class="form form-horizontal" id="myFrom_edit" method="post" action="apps/news/xhr/action-up-photo.php"  role="form" enctype="multipart/form-data">
            <div class="form-group">
