<?php
class meClass{
	private $app = "News and Promotions";
	private $dbc = null;
	...
	private $header_meta = array(
		array('category'	,"News and Promotion",	'fa fa-group'),
	...
	function PageHeader($active){
		echo '<div id="breadcrumb">';
			echo '<ul class="breadcrumb push-down-0">';
				echo ' <li><a href="?app='.$this->app.'"> Website Custom</a></li>';
				echo ' <li><a href="?app='.$this->app.'"> New and Promotions</a></li>';
