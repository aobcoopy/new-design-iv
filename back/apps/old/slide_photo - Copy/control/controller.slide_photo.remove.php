<?php
	include_once "apps/banner/view/dialog.banner.remove.php";
?>
<script style="text/javascript">
	
	fn.app.banner.banner.remove = function(){
	...
	$("#dialog_remove_group .btnConfirm").click(function(){
		var item_selected = $("#tblGroup").data("selected");
		$.post('apps/banner/xhr/action-remove-banner.php',{items:item_selected},function(response){
