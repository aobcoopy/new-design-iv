<?php
	include_once "apps/orders/view/dialog.orders.remove.php";
?>
<script style="text/javascript">
	
	fn.app.orders.orders.remove = function(){
	...
	$("#dialog_remove_group .btnConfirm").click(function(){
		var item_selected = $("#tblGroup").data("selected");
		$.post('apps/orders/xhr/action-remove-orders.php',{items:item_selected},function(response){
