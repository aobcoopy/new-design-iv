...
$(function(){
	...
	$("#tblGroup").DataTable({
		"processing": true,
		"serverSide": true,
		"ajax": "apps/orders/store/store-orders.php",
		"aoColumns": [
			{ "bSortable": false},
			{"bSort" : true},
			{"bSortable": true},
		...
		"createdRow": function ( row, data, index ) {
			...
			s = '';
			s += fn.engine.datatable.button('btn-default','fa-search','fn.app.orders.orders.change('+data[0]+')');
			s += ' ';
			s += fn.engine.datatable.button('btn-info','fa-check-square-o ','fn.app.orders.orders.save_change('+data[0]+')');
			$('td', row).eq(11).html(s);
