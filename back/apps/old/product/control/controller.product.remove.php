<?php
	include_once "apps/product/view/dialog.product.remove.php";
?>
<script style="text/javascript">
	
	fn.app.product.product.remove = function(){
	...
	$("#dialog_remove_group .btnConfirm").click(function(){
		var item_selected = $("#tblGroup").data("selected");
		$.post('apps/product/xhr/action-remove-product.php',{items:item_selected},function(response){
