<?php
	include_once "apps/yacth_destination/view/dialog.yacth_destination.remove.php";
?>
<script style="text/javascript">
	
	fn.app.yacth_destination.yacth_destination.remove = function(){
	...
	$("#btnRemoveGroup").click(function(){
		fn.app.yacth_destination.yacth_destination.remove();
	});
	...
	$("#dialog_remove_group .btnConfirm").click(function(){
		var item_selected = $("#tblSlide").data("selected");
		$.post('apps/yacth_destination/xhr/action-remove-yacth_destination.php',{items:item_selected},function(response){
