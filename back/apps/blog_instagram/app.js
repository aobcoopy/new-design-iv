...
var edit = {
	change_status:function(id){
		$.ajax({
				url: "apps/blog_instagram/xhr/action-change-status.php",
				type: "POST",
				dataType:"json",
				data: {id:id},
	...
	change_heightlight:function(id){
		$.ajax({
				url: "apps/blog_instagram/xhr/action-change-heightlight.php",
				type: "POST",
				dataType:"json",
				data: {id:id},
				success : function(response)
	...
	change_lifestyle:function(id){
		$.ajax({
				url: "apps/blog_instagram/xhr/action-change-lifestyle.php",
				type: "POST",
				dataType:"json",
				data: {id:id},
				success : function(response)
...
$.extend(fn.app,{blog_instagram:blog_instagram,edit:edit});