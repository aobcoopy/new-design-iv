<?php
	include_once "apps/rooms/view/dialog.rooms.remove.php";
?>
<script style="text/javascript">
	
	fn.app.rooms.rooms.remove = function(){
	...
	$("#dialog_remove_group .btnConfirm").click(function(){
		var item_selected = $("#tblSlide").data("selected");
		$.post('apps/rooms/xhr/action-remove-rooms.php',{items:item_selected},function(response){
