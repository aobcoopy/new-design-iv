...
//                                        }
									...
									$che = ($properties['cate_icon']==$r_cate['id'])?'checked':'';
										echo '<div class="radio">';
											echo '<label>';
												...
												{
													echo '<image xlink:href="' .  S3_BUCKET_URL . '/upload/'.$photo[$ii].'"   height="20" />';
												}
												else
												{
													echo '<image xlink:href="' .  S3_BUCKET_URL . '/upload/'.$photo[$ii].'"   height="20" />';
                           ...
                           <!-- <div class="form-group">
							...
							<label for="txtName" class="col-sm-2 control-label">Discount Price</label>
								...
								<label for="txtName" class="col-sm-2 control-label">Promotion Expire Date</label>
                                <div class="col-sm-4">
                                    <input type="date" class="form-control" id="txPEXP_e" name="txPEXP_e" value="<?php echo $properties['pro_exp'];?>" readonly>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <input type="number" class="form-control" id="txPrice_min_e_TH" name="txPrice_min_e_TH"  min="0" value="<?php echo $properties['pmin_th'];?>">
                                </div>
                            <!--</div>
                            <div class="form-group">-->
                                <label for="txtName" class="col-sm-2 control-label">Price TH Max</label>
                                <div class="col-sm-4">
                                    <input type="number" class="form-control" id="txPrice_max_e_TH" name="txPrice_max_e_TH"  min="0" value="<?php echo $properties['pmax_th'];?>">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <input type="date" id="tx_tag_exp_e" name="tx_tag_exp_e"  class="form-control" value="<?php echo $properties['tag_exp'];?>">
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <input type="number" id="tx_Bathroom_e" name="tx_Bathroom_e"  min="0" step="0.1" class="form-control" value="<?php echo $properties['bathroom'];?>">
                                </div>
                            </div>
                        </div>
                    </div>
												...
												echo '<div class="col-md-2">';
													...
													echo '<svg width="30" height="30">';
														...
														else
														{
															...
															{
																echo '<image xlink:href="' .  S3_BUCKET_URL .''.json_decode($bed_r['icon'],true).'"  width="30" height="30" />';//src="'.json_decode($fes_r['icon'],true).'"
															}
															else
															{
																echo '<image xlink:href="' .  S3_BUCKET_URL . '/upload/icons/'.$svg[0].'.svg"  width="30" height="30" />';//src="'.json_decode($fes_r['icon'],true).'"
												...
												echo '<div class="col-md-2">';
													...
													echo '<svg width="30" height="30">';
														...
														else
														{
															...
															{
																echo '<image xlink:href="' .  S3_BUCKET_URL .''.json_decode($app_r['icon'],true).'"  width="30" height="30" />';//src="'.json_decode($fes_r['icon'],true).'"
															}
															else
															{
																echo '<image xlink:href="' .  S3_BUCKET_URL . '/upload/icons/'.$svg[0].'.svg"  width="30" height="30" />';//src="'.json_decode($fes_r['icon'],true).'"
                    ...
                    <div role="tabpanel" class="tab-pane" id="what_include_e">
                    	<div class="col-md-12">
                        	<div class="form-group">
                                ...
                                <button type="button" class="btn btn-info" onClick="fn.app.properties.properties.addwiic_main('wiic_main_e','tx_main_e');"><i class="fa fa-plus"></i></button></label>
                                <!--<input type="text" class="ii" value="0">-->
                                <div class="col-sm-10 wiic_main_e">
                                    <?php 
									if($properties['wiic']==1)
									{
										$what_ic1 = json_decode($properties['what_ic1']);
										foreach($what_ic1 as $wic1)
										{
											echo '<div class="">';
												echo '<div class="row">';
													echo '<div class="col-sm-8">';
														echo '<input type="text" class="form-control" name="tx_main_e[]" value="'.str_replace("#","'",$wic1).'">';
													echo '</div> ';
													echo '<div class="col-sm-2">';
														echo '<button type="button" class="btn btn-danger" onClick="$(this).parent().parent().remove();"><i class="fa fa-remove"></i></button>';
													echo '</div> <br> ';
												echo '</div> '; 
											echo '</div> ';
										}
											...
											if(in_array($wic_r['id'],$ar_wic))
											{
											   /* echo '<div class="col-md-12">';
												...
												echo '<div class="">';
													echo '<div class="row">';
														echo '<div class="col-sm-8">';
															echo '<input type="text" class="form-control" name="tx_main_e[]" value="'.$wic_r['name'].'">';
														echo '</div> ';
														echo '<div class="col-sm-2">';
															echo '<button type="button" class="btn btn-danger" onClick="$(this).parent().parent().remove();"><i class="fa fa-remove"></i></button>';
														echo '</div> <br> ';
                            ...
                            <div class="form-group">
                                ...
                                <button type="button" class="btn btn-info" onClick="fn.app.properties.properties.addwiic_main('wiic_available_e','tx_available_e');"><i class="fa fa-plus"></i></button></label>
                                <!--<input type="text" class="ii" value="0">-->
                                <div class="col-sm-10 wiic_available_e">
                                    <?php 
										$what_ic6 = json_decode($properties['what_ic6']);
										foreach($what_ic6 as $wic6)
										{
											echo '<div class="">';
												echo '<div class="row">';
													echo '<div class="col-sm-8">';
														echo '<input type="text" class="form-control" name="tx_available_e[]" value="'.str_replace("#","'",$wic6).'">';
													echo '</div> ';
													echo '<div class="col-sm-2">';
														echo '<button type="button" class="btn btn-danger" onClick="$(this).parent().parent().remove();"><i class="fa fa-remove"></i></button>';
													echo '</div> <br> ';
                            ...
                            <div class="form-group">
                                ...
                                <button type="button" class="btn btn-info" onClick="fn.app.properties.properties.addwiic_main('wiic_House_e','tx_House_e');"><i class="fa fa-plus"></i></button></label>
                                <!--<input type="text" class="ii" value="0">-->
                                <div class="col-sm-10 wiic_House_e">
                                    <?php 
										$what_ic7 = json_decode($properties['what_ic7']);
										foreach($what_ic7 as $wic7)
										{
											echo '<div class="">';
												echo '<div class="row">';
													echo '<div class="col-sm-8">';
														echo '<input type="text" class="form-control" name="tx_House_e[]" value="'.str_replace("#","'",$wic7).'">';
													echo '</div> ';
													echo '<div class="col-sm-2">';
														echo '<button type="button" class="btn btn-danger" onClick="$(this).parent().parent().remove();"><i class="fa fa-remove"></i></button>';
													echo '</div> <br> ';
                            ...
                            <div class="form-group">
                                ...
                                <button type="button" class="btn btn-info" onClick="fn.app.properties.properties.addwiic_main('wiic_transfer_e','tx_transfer_e');"><i class="fa fa-plus"></i></button></label></label>
                                
                                <div class="col-sm-10 wiic_transfer_e">
                                    <?php 
									
									if($properties['wiic']==1)
									{
										$what_ic2 = json_decode($properties['what_ic2']);
										foreach($what_ic2 as $wic2)
										{
											echo '<div class="">';
													echo '<div class="row">';
														echo '<div class="col-sm-8">';
															echo '<input type="text" class="form-control" name="tx_transfer_e[]" value="'.str_replace("#","'",$wic2).'">';
														echo '</div> ';
														echo '<div class="col-sm-2">';
															echo '<button type="button" class="btn btn-danger" onClick="$(this).parent().parent().remove();"><i class="fa fa-remove"></i></button>';
														echo '</div> <br> ';
										...
										while($wic_r = $dbc->Fetch($sql_wic))
										{
											...
											if(in_array($wic_r['id'],$ar_wic))
											{
												...
												echo '<div class="">';
													echo '<div class="row">';
														echo '<div class="col-sm-8">';
															echo '<input type="text" class="form-control" name="tx_transfer_e[]" value="'.$wic_r['name'].'">';
														echo '</div> ';
														echo '<div class="col-sm-2">';
															echo '<button type="button" class="btn btn-danger" onClick="$(this).parent().parent().remove();"><i class="fa fa-remove"></i></button>';
														echo '</div> <br> ';
                            ...
                            <div class="form-group">
                                ...
                                <button type="button" class="btn btn-info" onClick="fn.app.properties.properties.addwiic_main('wiic_service_e','tx_service_e');"><i class="fa fa-plus"></i></button></label></label>
                                <div class="col-sm-10 wiic_service_e">
                                    <?php 
									
									if($properties['wiic']==1)
									{
										$what_ic3 = json_decode($properties['what_ic3']);
										foreach($what_ic3 as $wic3)
										{
											echo '<div class="">';
												echo '<div class="row">';
													echo '<div class="col-sm-8">';
														echo '<input type="text" class="form-control" name="tx_service_e[]" value="'.str_replace("#","'",$wic3).'">';
													echo '</div> ';
													echo '<div class="col-sm-2">';
														echo '<button type="button" class="btn btn-danger" onClick="$(this).parent().parent().remove();"><i class="fa fa-remove"></i></button>';
													echo '</div> <br> ';
										...
										while($wic_r = $dbc->Fetch($sql_wic))
										{
											...
											if(in_array($wic_r['id'],$ar_wic))
											{
												...
												echo '<div class="">';
													echo '<div class="row">';
														echo '<div class="col-sm-8">';
															echo '<input type="text" class="form-control" name="tx_service_e[]" value="'.$wic_r['name'].'">';
														echo '</div> ';
														echo '<div class="col-sm-2">';
															echo '<button type="button" class="btn btn-danger" onClick="$(this).parent().parent().remove();"><i class="fa fa-remove"></i></button>';
														echo '</div> <br> ';
                            ...
                            <div class="form-group">
                                ...
                                <button type="button" class="btn btn-info" onClick="fn.app.properties.properties.addwiic_main('wiic_charge_e','tx_Charge_e');"><i class="fa fa-plus"></i></button></label></label>
                                <div class="col-sm-10 wiic_charge_e">
                                    <?php 
									if($properties['wiic']==1)
									{
										$what_ic4 = json_decode($properties['what_ic4']);
										foreach($what_ic4 as $wic4)
										{
											echo '<div class="">';
												echo '<div class="row">';
													echo '<div class="col-sm-8">';
														echo '<input type="text" class="form-control" name="tx_Charge_e[]" value="'.str_replace("#","'",$wic4).'">';
													echo '</div> ';
													echo '<div class="col-sm-2">';
														echo '<button type="button" class="btn btn-danger" onClick="$(this).parent().parent().remove();"><i class="fa fa-remove"></i></button>';
													echo '</div> <br> ';
										...
										while($wic_r = $dbc->Fetch($sql_wic))
										{
											...
											if(in_array($wic_r['id'],$ar_wic))
											{
												...
												echo '<div class="">';
													echo '<div class="row">';
														echo '<div class="col-sm-8">';
															echo '<input type="text" class="form-control" name="tx_Charge_e[]" value="'.$wic_r['name'].'">';
														echo '</div> ';
														echo '<div class="col-sm-2">';
															echo '<button type="button" class="btn btn-danger" onClick="$(this).parent().parent().remove();"><i class="fa fa-remove"></i></button>';
														echo '</div> <br> ';
                            ...
                            <div class="form-group">
                                ...
                                <button type="button" class="btn btn-info" onClick="fn.app.properties.properties.addwiic_main('wiic_Special_e','tx_Special_e');"><i class="fa fa-plus"></i></button></label></label>
                                <div class="col-sm-10 wiic_Special_e">
                                    <?php 
									if($properties['wiic']==1)
									{
										$what_ic5 = json_decode($properties['what_ic5']);
										foreach($what_ic5 as $wic5)
										{
											echo '<div class="">';
												echo '<div class="row">';
													echo '<div class="col-sm-8">';
														echo '<input type="text" class="form-control" name="tx_Special_e[]" value="'.str_replace("#","'",$wic5).'">';
													echo '</div> ';
													echo '<div class="col-sm-2">';
														echo '<button type="button" class="btn btn-danger" onClick="$(this).parent().parent().remove();"><i class="fa fa-remove"></i></button>';
													echo '</div> <br> ';
										...
										while($wic_r = $dbc->Fetch($sql_wic))
										{
											...
											if(in_array($wic_r['id'],$ar_wic))
											{
												...
												echo '<div class="">';
													echo '<div class="row">';
														echo '<div class="col-sm-8">';
															echo '<input type="text" class="form-control" name="tx_Special_e[]" value="'.$wic_r['name'].'">';
														echo '</div> ';
														echo '<div class="col-sm-2">';
															echo '<button type="button" class="btn btn-danger" onClick="$(this).parent().parent().remove();"><i class="fa fa-remove"></i></button>';
														echo '</div> <br> ';
