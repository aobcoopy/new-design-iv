...
var edit = {
	change_status:function(id){
		$.ajax({
				url: "apps/quick_link/xhr/action-change-status.php",
				type: "POST",
				dataType:"json",
				data: {id:id},
	...
	gotolink:function(links){
		alert(links);
		window.location = 'https://staging.inspiringvillas.com'+links;
	}
};

$.extend(fn.app,{quick_link:quick_link,edit:edit});