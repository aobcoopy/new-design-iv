<?php
	include_once "apps/quick_link/view/dialog.quick_link.remove.php";
?>
<script style="text/javascript">
	
	fn.app.quick_link.quick_link.remove = function(){
	...
	$("#btnRemoveGroup").click(function(){
		fn.app.quick_link.quick_link.remove();
	});
	...
	$("#dialog_remove_group .btnConfirm").click(function(){
		var item_selected = $("#tblSlide").data("selected");
		$.post('apps/quick_link/xhr/action-remove-quick_link.php',{items:item_selected},function(response){
