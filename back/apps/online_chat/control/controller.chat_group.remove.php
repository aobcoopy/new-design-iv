<?php
	include_once "apps/chat_group/view/dialog.chat_group.remove.php";
?>
<script style="text/javascript">
	
	fn.app.chat_group.chat_group.remove = function(){
	...
	$("#btnRemoveGroup").click(function(){
		fn.app.chat_group.chat_group.remove();
	});
	...
	$("#dialog_remove_group .btnConfirm").click(function(){
		var item_selected = $("#tblGroup").data("selected");
		$.post('apps/chat_group/xhr/action-remove-chat_group.php',{items:item_selected},function(response){
