<?php
	include_once "apps/yacth_prefer_program/view/dialog.yacth_prefer_program.remove.php";
?>
<script style="text/javascript">
	
	fn.app.yacth_prefer_program.yacth_prefer_program.remove = function(){
	...
	$("#btnRemoveGroup").click(function(){
		fn.app.yacth_prefer_program.yacth_prefer_program.remove();
	});
	...
	$("#dialog_remove_group .btnConfirm").click(function(){
		var item_selected = $("#tblSlide").data("selected");
		$.post('apps/yacth_prefer_program/xhr/action-remove-yacth_prefer_program.php',{items:item_selected},function(response){
