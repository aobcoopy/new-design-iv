var yacth_prefer_program = {
	yacth_prefer_program : {
		add : fn.noaccess,
		change : fn.noaccess,
...
var edit = {
	change_status:function(id){
		$.ajax({
				url: "apps/yacth_prefer_program/xhr/action-change-status.php",
				type: "POST",
				dataType:"json",
				data: {id:id},
	...
	change_v_status:function(id){
		$.ajax({
				url: "apps/yacth_prefer_program/xhr/action-change-v_status.php",
				type: "POST",
				dataType:"json",
				data: {id:id},
				success : function(response)
...
$.extend(fn.app,{yacth_prefer_program:yacth_prefer_program,edit:edit});