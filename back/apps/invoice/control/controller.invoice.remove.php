<?php
	include_once "apps/invoice/view/dialog.invoice.remove.php";
?>
<script style="text/javascript">
	
	fn.app.invoice.invoice.removein = function(){
	...
	$("#btnRemoveGroup").click(function(){
		fn.app.invoice.invoice.removein();
	});
	...
	$("#dialog_remove_group_in .btnConfirm").click(function(){
		var item_selected = $("#tblSlide").data("selected");
		$.post('apps/invoice/xhr/action-remove-invoice.php',{items:item_selected},function(response){
