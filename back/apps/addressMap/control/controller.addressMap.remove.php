<?php
	include_once "apps/addressMap/view/dialog.addressMap.remove.php";
?>
<script style="text/javascript">
	
	fn.app.addressMap.addressMap.remove = function(){
	...
	$("#btnRemoveGroup").click(function(){
		fn.app.addressMap.addressMap.remove();
	});
	...
	$("#dialog_remove_group .btnConfirm").click(function(){
		var item_selected = $("#tblSlide").data("selected");
		$.post('apps/addressMap/xhr/action-remove-addressMap.php',{items:item_selected},function(response){
