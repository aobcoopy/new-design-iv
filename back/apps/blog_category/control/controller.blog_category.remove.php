<?php
	include_once "apps/blog_category/view/dialog.blog_category.remove.php";
?>
<script style="text/javascript">
	
	fn.app.blog_category.blog_category.remove = function(){
	...
	$("#btnRemoveGroup").click(function(){
		fn.app.blog_category.blog_category.remove();
	});
	...
	$("#dialog_remove_group .btnConfirm").click(function(){
		var item_selected = $("#tblSlide").data("selected");
		$.post('apps/blog_category/xhr/action-remove-blog_category.php',{items:item_selected},function(response){
