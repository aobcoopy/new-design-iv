<?php
	...
	$img_photo_main = json_decode($blog_category['photo'],true);//'../../../../'.json_decode($blog_category['photo_main'],true));
	$img_photo_hl_1 = json_decode($blog_category['photo_hl_1'],true);
	$img_photo_hl_2 = json_decode($blog_category['photo_hl_2'],true);
	$img_photo_hl_3 = json_decode($blog_category['photo_hl_3'],true);
	$img_photo_width = json_decode($blog_category['photo_width'],true);
	$img_photo_high = json_decode($blog_category['photo_high'],true);
	$img_photo_sq = json_decode($blog_category['photo_sq'],true);
	//$img_9 = json_decode($blog_category['img_9'],true);

	$path_photo_main = ($img_photo_main!='')?imagePath('/'.json_decode($blog_category['photo'],true)):'';//'../../../../'.json_decode($blog_category['photo_main']):'';
	$path_photo_hl_1 = ($img_photo_hl_1!='')?imagePath('/'.json_decode($blog_category['photo_hl_1'],true)):'';
	$path_photo_hl_2 = ($img_photo_hl_2!='')?imagePath('/'.json_decode($blog_category['photo_hl_2'],true)):'';
	$path_photo_hl_3 = ($img_photo_hl_3!='')?imagePath('/'.json_decode($blog_category['photo_hl_3'],true)):'';
	$path_photo_width = ($img_photo_width!='')?imagePath('/'.json_decode($blog_category['photo_width'],true)):'';
	$path_photo_high = ($img_photo_high!='')?imagePath('/'.json_decode($blog_category['photo_high'],true)):'';
	$path_photo_sq = ($img_photo_sq!='')?imagePath('/'.json_decode($blog_category['photo_sq'],true)):'';
	//$path_9 = ($img_9!='')?'../../../../'.json_decode($blog_category['img_9']):'';

	
	$image_photo_main = ($img_photo_main!='')?'<img src="'.imagePath('/'.$img_photo_main).'" class="img_photo"  width="100%">':'<img src="../../../../upload/photo.jpg"  class="img_photo_main" width="100%">';
...
<div class="modal fade" id="dialog_edit_group" data-backdrop="static">
  	<div class="modal-dialog  modal-lg" style="width:90%">
		<form id="form_edit_property" class="form-horizontal" role="form" enctype="multipart/form-data"  onsubmit="fn.app.blog_category.blog_category.save_photo(this);return false;">
		<input type="hidden" name="txtID" value="<?php echo $blog_category['id'];?>">
        <input type="hidden" name="txtName" value="<?php echo $blog_category['name'];?>">
                    ...
                    <div role="tabpanel" class="tab-pane active" id="Information_e">
                    	<div class="col-md-12">
                            ...
                            <div class="form-group col-md-4 ">
                            	<h2>Main Photo</h2>
                                <div class="col-sm-12">
                                    <button type="button" class="btn btn-primary" onClick="fn.app.blog_category.blog_category.choose_photo_popup('butUploadPhoto_photo_main');">Upload</button>
                                    <button type="button" class="btn btn-danger" <?php echo ($path_photo_main!='')?'':'disabled';?> onClick="fn.app.blog_category.blog_category.remove_multi_photo('<?php echo $path_photo_main;?>',this,'img_photo','<?php echo $_REQUEST['id'];?>');"><i class="fa fa-remove"></i></button>
                                    <!--<button type="submit" class="btn btn-primary pull-right">Save</button>-->
                                    <font color="#ff0000"> 523 x 625 px</font>
                                    
                                    <div class="custom-file">
                                        <input type="file" class="custom-file-input validate hidden" id="butUploadPhoto_photo_main" name="butUploadPhoto_photo_main" placeholder="img" onchange="fn.app.blog_category.blog_category.showImgPopup(this);">
                                    ...
                                    <div class="form-group row"><br>
                                        ...
                                        <label class="custom-file-label img_photo" for="img"><?php echo $img_photo_main; ?></label>
                                        </div>
                            ...
                            <?php /*?><div class="form-group col-md-4 hidden">
