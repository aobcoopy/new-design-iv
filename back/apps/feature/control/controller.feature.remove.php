<?php
	include_once "apps/feature/view/dialog.feature.remove.php";
?>
<script style="text/javascript">
	
	fn.app.feature.feature.remove = function(){
	...
	$("#dialog_remove_group .btnConfirm").click(function(){
		var item_selected = $("#tblSlide").data("selected");
		$.post('apps/feature/xhr/action-remove-feature.php',{items:item_selected},function(response){
