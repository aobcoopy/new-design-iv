<?php
	include_once "apps/appliances/view/dialog.appliances.remove.php";
?>
<script style="text/javascript">
	
	fn.app.appliances.appliances.remove = function(){
	...
	$("#btnRemoveGroup").click(function(){
		fn.app.appliances.appliances.remove();
	});
	...
	$("#dialog_remove_group .btnConfirm").click(function(){
		var item_selected = $("#tblSlide").data("selected");
		$.post('apps/appliances/xhr/action-remove-appliances.php',{items:item_selected},function(response){
