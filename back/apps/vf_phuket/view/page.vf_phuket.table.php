<div class="col-md-12">
	<div class="panel panel-default">
		<div id="panel-heading-group" class="panel-heading">
	        <h3 class="panel-title">Villa Form <button type="button" class="btn btn-info" >Template</button></h3>
	...
	?>
		...
		$("#tblSlide_<?php echo $deslist_2;?>").DataTable({
			...
			"createdRow": function ( row, data, index ) {
				...
				s = '';
				s += '<input type="hidden" class="tx_vname_encode" value="'+data[8]+'">';
				s += fn.engine.datatable.button('btn-default','fa-pencil','fn.app.vf_phuket.edit_form('+data[0]+',this)','Edit Form',' Edit Form Template');
				s += ' ';
				/*s += fn.engine.datatable.button('btn-info','fa-search','fn.app.vf_phuket.view_form('+data[0]+')','View Form',' ');
				s += ' ';*/
				s += fn.engine.datatable.button('btn-success','fa-plus','fn.app.vf_phuket.dialog_add_user('+data[0]+','+data[5]+')','Add Customer',' Add Customer');
				s += ' ';
