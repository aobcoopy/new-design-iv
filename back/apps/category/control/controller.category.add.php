...
<script style="text/javascript">
	...
	fn.app.category.category.add = function(){
		if(document.getElementById("txTitle").value=='' 
            || document.getElementById("txSlug").value=='' 
            || document.getElementById("txBrief").value=='' 
		...
		else
		{
			...
			if(response.success){
				...
				$(".phos").attr('src','');
				$(".bc").hide();
				//$("#thumbnail").attr('src','../../../../upload/category.jpg');
			}else{
	...
	fn.app.category.category.upload_photo = function(){
	...
	fn.app.category.category.upload_photo_file = function(){
		...
		var url = 'apps/category/xhr/action-up-photo.php?format_photo_name='+new_path_name;
		jQuery.ajax({
			url: url,
			data: data,
			cache: false,
	...
	/*fn.app.category.category.remove_photo = function(me){
	...
	fn.app.category.category.upload_photo_cover = function(){
	...
	fn.app.category.category.upload_photo_file_cover = function(){
	...
	/*fn.app.category.category.remove_photo_cover = function(me){
