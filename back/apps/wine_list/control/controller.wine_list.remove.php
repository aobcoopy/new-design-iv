<?php
	include_once "apps/wine_list/view/dialog.wine_list.remove.php";
?>
<script style="text/javascript">
	
	fn.app.wine_list.wine_list.remove = function(){
	...
	$("#btnRemoveGroup").click(function(){
		fn.app.wine_list.wine_list.remove();
	});
	...
	$("#dialog_remove_group .btnConfirm").click(function(){
		var item_selected = $("#tblSlide").data("selected");
		$.post('apps/wine_list/xhr/action-remove-wine_list.php',{items:item_selected},function(response){
