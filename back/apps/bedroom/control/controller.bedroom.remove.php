<?php
	include_once "apps/bedroom/view/dialog.bedroom.remove.php";
?>
<script style="text/javascript">
	
	fn.app.bedroom.bedroom.remove = function(){
	...
	$("#dialog_remove_group .btnConfirm").click(function(){
		var item_selected = $("#tblSlide").data("selected");
		$.post('apps/bedroom/xhr/action-remove-bedroom.php',{items:item_selected},function(response){
