<?php
	include_once "apps/faqs/view/dialog.faqs.remove.php";
?>
<script style="text/javascript">
	
	fn.app.faqs.faqs.remove = function(){
	...
	$("#dialog_remove_group .btnConfirm").click(function(){
		var item_selected = $("#tblGroup").data("selected");
		$.post('apps/faqs/xhr/action-remove-faqs.php',{items:item_selected},function(response){
