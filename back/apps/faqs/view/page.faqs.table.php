...
$(function(){
	...
	$("#tblGroup").DataTable({
		"processing": true,
		"serverSide": true,
		//"ajax": "apps/faqs/store/store-faqs.php",
		"ajax": {
            "url": "apps/faqs/store/store-faqs.php",
            "type": "POST"
        },
		"aoColumns": [
			{ "bSortable": false},
		...
		"createdRow": function ( row, data, index ) {
			...
			s = '';
			s += fn.engine.datatable.button('btn-default','fa-pencil','fn.app.faqs.faqs.change('+data[0]+')');
			s += ' ';
			//s += fn.engine.datatable.button('btn-warning','fa-lock','fn.app.faqs.group.permission('+data[0]+')');
			$('td', row).eq(6).html(s);
