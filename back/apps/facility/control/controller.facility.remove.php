<?php
	include_once "apps/facility/view/dialog.facility.remove.php";
?>
<script style="text/javascript">
	
	fn.app.facility.facility.remove = function(){
	...
	$("#btnRemoveGroup").click(function(){
		fn.app.facility.facility.remove();
	});
	...
	$("#dialog_remove_group .btnConfirm").click(function(){
		var item_selected = $("#tblSlide").data("selected");
		$.post('apps/facility/xhr/action-remove-facility.php',{items:item_selected},function(response){
