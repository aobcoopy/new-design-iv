...
var edit = {
	change_status:function(id){
		$.ajax({
				url: "apps/yacth_charter/xhr/action-change-status.php",
				type: "POST",
				dataType:"json",
				data: {id:id},
	...
	change_v_status:function(id){
		$.ajax({
				url: "apps/yacth_charter/xhr/action-change-v_status.php",
				type: "POST",
				dataType:"json",
				data: {id:id},
				success : function(response)
...
$.extend(fn.app,{yacth_charter:yacth_charter,edit:edit});