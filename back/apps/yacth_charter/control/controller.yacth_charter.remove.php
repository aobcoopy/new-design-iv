<?php
	include_once "apps/yacth_charter/view/dialog.yacth_charter.remove.php";
?>
<script style="text/javascript">
	
	fn.app.yacth_charter.yacth_charter.remove = function(){
	...
	$("#btnRemoveGroup").click(function(){
		fn.app.yacth_charter.yacth_charter.remove();
	});
	...
	$("#dialog_remove_group .btnConfirm").click(function(){
		var item_selected = $("#tblSlide").data("selected");
		$.post('apps/yacth_charter/xhr/action-remove-yacth_charter.php',{items:item_selected},function(response){
