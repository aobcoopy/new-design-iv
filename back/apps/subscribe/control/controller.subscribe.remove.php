<?php
	include_once "apps/subscribe/view/dialog.subscribe.remove.php";
?>
<script style="text/javascript">
	
	fn.app.subscribe.subscribe.remove = function(){
	...
	$("#btnRemoveGroup").click(function(){
		fn.app.subscribe.subscribe.remove();
	});
	...
	$("#dialog_remove_group .btnConfirm").click(function(){
		var item_selected = $("#tblGroup").data("selected");
		$.post('apps/subscribe/xhr/action-remove-subscribe.php',{items:item_selected},function(response){
