...
$(function(){
	...
	$("#tblGroup").DataTable({
		"processing": true,
		"serverSide": true,
		"ajax": "apps/subscribe/store/store-subscribe.php",
		dom: 'Bfrtip',
        buttons: [
            'csv', 'excel', 'pdf', 'print'
        ],
...
//			{"bSortable": false },
		...
		"createdRow": function ( row, data, index ) {
			...
			s = '';
			s += fn.engine.datatable.button('btn-default','fa-search','fn.app.subscribe.subscribe.view('+data[0]+')');
			s += ' ';
			//s += fn.engine.datatable.button('btn-warning','fa-lock','fn.app.subscribe.group.permission('+data[0]+')');
			$('td', row).eq(5).html(s);
