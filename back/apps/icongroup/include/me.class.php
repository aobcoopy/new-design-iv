...
class meClass{
	...
	private $header_meta = array(
		array('icongroup'	,"Icon group",	'fa fa-group'),
	...
	function PageHeader($active){
		echo '<div id="breadcrumb">';
			echo '<ul class="breadcrumb push-down-0">';
				echo ' <li><a href="?app='.$this->app.'"> Icon Management</a></li>';
				echo ' <li><a href="?app='.$this->app.'"> Icon group</a></li>';
