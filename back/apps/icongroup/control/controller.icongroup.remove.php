<?php
	include_once "apps/icongroup/view/dialog.icongroup.remove.php";
?>
<script style="text/javascript">
	
	fn.app.icongroup.icongroup.remove = function(){
	...
	$("#btnRemoveGroup").click(function(){
		fn.app.icongroup.icongroup.remove();
	});
	...
	$("#dialog_remove_group .btnConfirm").click(function(){
		var item_selected = $("#tblSlide").data("selected");
		$.post('apps/icongroup/xhr/action-remove-icongroup.php',{items:item_selected},function(response){
