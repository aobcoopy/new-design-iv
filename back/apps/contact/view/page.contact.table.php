...
<form>
  <div class="form-row">
    <div class="form-group col-md-5">
      ...
      <input type="date" class="form-control" id="date_start" name="date_start" value="<?php echo date("Y-m-d");?>" >
    </div>
    <div class="form-group col-md-5">
...
function load_data()
{
	...
	$('#tblGroup').DataTable( {
		...
		"processing": true,
		"serverSide": true,
    	"ajax" : "apps/contact/store/store-contact.php?tx_start="+start+"&tx_end="+end+"",
   		"lengthMenu": [[-1], [ "All"]],
		dom: 'Bfrtip',
        buttons: [
            'csv', 'excel', 'pdf', 'print'
