<?php
	include_once "apps/blog/view/dialog.blog.remove.php";
?>
<script style="text/javascript">
	
	fn.app.blog.blog.remove = function(){
	...
	$("#dialog_remove_group .btnConfirm").click(function(){
		...
		$.post('apps/blog/xhr/action-remove-blog.php',{items:item_selected},function(response){
