...
class meClass{
	...
	private $header_meta = array(
		array('what_include'	,"What is include Management",	'fa fa-group'),
	...
	function PageHeader($active){
		echo '<div id="breadcrumb">';
			echo '<ul class="breadcrumb push-down-0">';
				echo ' <li><a href="?app='.$this->app.'"> What is include Management</a></li>';
				//echo ' <li><a href="?app='.$this->app.'"> Subdestination</a></li>';
