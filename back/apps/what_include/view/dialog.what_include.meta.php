...
<div class="modal fade" id="dialog_edit_group" data-backdrop="static">
  	<div class="modal-dialog">
		<form id="form_edit_meta" class="form-horizontal" role="form" onsubmit="fn.app.what_include.what_include.save_meata();return false;">
    	...
    	<div class="modal-content">
		    ...
		    <div class="modal-body">
            	<div class="form-group">
					...
					<div class="col-sm-10">
						<textarea type="text" class="form-control" id="tx_metat" name="tx_metat"  rows="4" maxlength="160"><?php echo $what_include['meta'];?></textarea>
					</div>
				</div>
