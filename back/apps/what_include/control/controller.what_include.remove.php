<?php
	include_once "apps/what_include/view/dialog.what_include.remove.php";
?>
<script style="text/javascript">
	
	fn.app.what_include.what_include.remove = function(){
	...
	$("#btnRemoveGroup").click(function(){
		fn.app.what_include.what_include.remove();
	});
	...
	$("#dialog_remove_group .btnConfirm").click(function(){
		var item_selected = $("#tblSlide").data("selected");
		$.post('apps/what_include/xhr/action-remove-what_include.php',{items:item_selected},function(response){
