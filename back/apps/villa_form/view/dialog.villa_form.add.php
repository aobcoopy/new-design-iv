...
<div class="modal fade" id="dialog_add_villa_form" data-backdrop="static">
  	<div class="modal-dialog" style="width:70%;">
		<form id="form_add_villa_form" class="form-horizontal" role="form" onsubmit="fn.app.villa_form.villa_form.add();return false;">
    	<div class="modal-content">
      		<div class="modal-header">
        		<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
				<h4>Add Villa Form Koh Samui</h4>
      		</div>
...
function add_adm_to_box(me,id,names)
{
