<?php
	include_once "apps/faq/view/dialog.faq.remove.php";
?>
<script style="text/javascript">
	
	fn.app.faq.faq.remove = function(){
	...
	$("#dialog_remove_group .btnConfirm").click(function(){
		var item_selected = $("#tblGroup").data("selected");
		$.post('apps/faq/xhr/action-remove-faq.php',{items:item_selected},function(response){
