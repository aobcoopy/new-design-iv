...
//	}
	...
	$ar_data = array(
			'tx_sname_d' => $_REQUEST['tx_sname_d'],
			'tx_date_d' => $_REQUEST['tx_date_d'],
			'tx_airline_d' => $_REQUEST['tx_airline_d'],
			'tx_flight_d' => $_REQUEST['tx_flight_d'],
			'tx_time_d' => $_REQUEST['tx_time_d'],
			'tx_pass_d' => $_REQUEST['tx_pass_d'],
			'tx_transfer_d' => $_REQUEST['tx_transfer_d'],
			'tx_Contact_Number_d' => $_REQUEST['tx_Contact_Number_d'],
			'tx_Special_Request_d' => $_REQUEST['tx_Special_Request_d'],
			'tx_luggages_d' => $_REQUEST['tx_luggages_d'],
		);
