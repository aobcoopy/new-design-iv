<?php 
	...
	if (isset($_FILES['b_file']) && !empty($_FILES['b_file']['name'])) {
		$file_ext = pathinfo($_FILES['b_file']['name'], PATHINFO_EXTENSION);
		...
		if (move_uploaded_file($_FILES['b_file']['tmp_name'], $path)) {
