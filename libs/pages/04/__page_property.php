												...
												echo '<div class="col-xs-12 col-sm-6 col-md-4 web '.$pading_grid.' ">';//<a href="?page=blogdetail&blog='.$r_blog['id'].'">
													echo '<span itemscope itemtype="http://schema.org/Product" >';
														...
														echo '<div class="col-md-12 boxpho nopad">';
															...
															echo '<a href="/'.$row['ht_link'].'.html" target="_blank"><img itemprop="image"  src="'.imagePath($photo[0]['img']).'" width="100%"></a>';
														echo '</div>';
                                                ...
                                                //echo '<!--room-->';
                                                    ...
                                                    echo '<span itemprop="brand" itemscope itemtype="http://schema.org/Brand"><span itemprop="name" class="tw tbrand" >Inspiring Villas</span></span>';
														...
														echo '<div class="col-xs-12 col-sm-12 col-md-12 nopad villa_boxs_inside">';
                                                           ...
                                                           array_push($ar_photo,S3_BUCKET_URL.imagePath($photo[0]['img']));
                                                            $ar_url[] = array(
                                                              "@type" => "ListItem",
                                                              "name" => $name[0],
                                                              //"image" => "https://www.inspiringvillas.com".imagePath($photo[0]['img']),
                                                              "image" => S3_BUCKET_URL.imagePath($photo[0]['img']),
                                                              "position" => $zz,
                                                              //"url" => "https://www.inspiringvillas.com/".$row['ht_link'].".html",
                                                              "url" => S3_BUCKET_URL.$row['ht_link'].".html",
                                                              /*"author"=> array(
                                                                "@type" => "Person",
                                                                "name" => "Inspiring Villas"
                                                              ),*/
...
//                                            }
										...
										if($view=='grid')
										{
											if($zz=='3' || $zz=='6' || $zz=='10')
											{
												...
												echo '<div class="villa_boxs_mini photo_banner mob"><a href="/contact" ><img src="/upload/search/mm_1.jpg" width="100%" alt="CONCIERGE OFFER"> </a></div>';
										...
										else
										{
											if($zz=='3' || $zz=='9' || $zz=='15')
											{
												...
												//-----link
												/*echo '<div class="villa_boxs_mini photo_banner web"><a href="/contact#viewform" ><img src="/upload/search/1_11.jpg" width="100%" alt="CONCIERGE OFFER"></a></div>';
												echo '<div class="villa_boxs_mini photo_banner photo_banner_mob mob"><a href="/contact#viewform" ><img src="/upload/search/mm_11.jpg" width="100%" alt="CONCIERGE OFFER"></a></div>';*/
