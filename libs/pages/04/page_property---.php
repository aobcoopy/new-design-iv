...
//                                                                            echo '<div  class="top15 tb f15t- f17"><span itemprop="description" class="pt">'.base64_decode($row['short_det']).'</span></div>';//f13
//                                                                            echo '</div>';
//                                                                            //echo '<div class="col-xs-12 col-sm-12 col-md-12 padleft25 top10 t_t41">';
//                                                                            echo '<div class="col-xs-7 col-sm-6 col-md-6 padleft25 top20 t_t11">';
//                                                                                echo '<ul>';
//                                                                                    echo '<li>';
