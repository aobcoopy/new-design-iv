                        ...
                        <div role="tabpanel" class="tab-pane fade in active" id="select-room">
                            ...
                            <div class="mg-available-rooms">
                                ...
                                $sql__1 = $dbc->Query("SELECT properties.id AS id,properties.`name`,properties.brief,
                                            ...
                                            WHERE " . $thailandFilter . "(properties.status > 0 AND destinations.status > 0 ".$Destination." ".$beach." ".$price." ".$w_room." ".$w_cate." ".$w_actualbed." ".$in_list."
                                            " . $exclusionInclusionRule . "                                            
...
/*                                $_SESSION['stringActualBedrooms'] = implode(",", $arrayActualBedrooms);
                                ...
                                $query = "SELECT
                                          ...
                                          FROM
                                            ...
                                            WHERE " . $thailandFilter . "(properties.status > 0 AND destinations.status > 0 ".$Destination." ".$beach." ".$price." ".$w_room." ".$w_cate." ".$w_actualbed." ".$in_list . $exclusionInclusionRule . "  GROUP BY properties.id ORDER BY" . $sortByMostPopular . " price asc limit 5 ";
...
//                                            }
										...
										else
										{
											if($zz=='3' || $zz=='9' || $zz=='15')
											{
												...
												echo '<div class="villa_boxs_mini photo_banner photo_banner_mob mob"><a href="/contact#viewform" ><img src="/upload/search/mm111.jpg" width="100%" alt="CONCIERGE OFFER"></a></div>';
        ...
        if ($(this).scrollTop() > my_footers) 
        {
            ...
            if(tigg==true)
            {
                ...
                $.ajax({
                    ...
                    type:"POST",
                    dataType:"html",
                    data:{cbbDestination:des,cbbSub:beach,pri:price,starts:starts,cbbRoom:room,cbbCollection:cate,cbbSort:$("#cbbSort").val(),txs:$("#txs").val(),link_url:link_url,view:$("#view").val()},
