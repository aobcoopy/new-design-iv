...
$show_dis=false;
if($dis['dis_exp_1']=='0000-00-00' || $dis['dis_exp_1']=='null' || $dis['dis_exp_1']>=$Da_today)
{
	$show_dis=true;$nn=1;
}

if($dis['dis_exp_2']=='0000-00-00' || $dis['dis_exp_2']=='null' || $dis['dis_exp_2']>=$Da_today)
{
	$show_dis=true;$nn=2;
}

if($dis['dis_exp_3']=='0000-00-00' || $dis['dis_exp_3']=='null' || $dis['dis_exp_3']>=$Da_today)
{
	$show_dis=true;$nn=3;
}

if($dis['dis_exp_4']=='0000-00-00' || $dis['dis_exp_4']=='null' || $dis['dis_exp_4']>=$Da_today)
{
	$show_dis=true;$nn=4;
}

if($dis['dis_exp_5']=='0000-00-00' || $dis['dis_exp_5']=='null' || $dis['dis_exp_5']>=$Da_today)
{
	$show_dis=true;$nn=5;
}

if($dis['dis_exp_6']=='0000-00-00' || $dis['dis_exp_6']=='null' || $dis['dis_exp_6']>=$Da_today)
{
	$show_dis=true;$nn=6;
}

if($dis['dis_exp_7']=='0000-00-00' || $dis['dis_exp_7']=='null' || $dis['dis_exp_7']>=$Da_today)
{
	$show_dis=true;
	$nn=7;
}

if($dis['dis_exp_8']=='0000-00-00'  && $dis['dis_exp_8']>=$Da_today)
{
	$show_dis=true;
	$nn=8;
}

if($dis['dis_exp_9']=='0000-00-00' && $dis['dis_exp_9']>=$Da_today)
{
	$show_dis=true;
	$nn=9;
}
	...
	if($show_dis==true)
	{
     echo '<div class="col-md-12 mg-room-fecilities ">';
        ...
        echo '<div class="row bggold ">';
           echo '<div class="col-md-12 ">';
                 echo '<ul  class="bedr">';
                if($pri['early_percent']!='' && $pri['early_day']!='' && $dis['dis_exp_1']>=$Da_today)// 
                {
                ...
                if($pri['last_percent']!='' && $pri['last_date']!='0000-00-00' && $dis['dis_exp_2']>=$Da_today)//
                {
				...
				if($dis_dat==true)
				{
					if($dis['early_1']!='' && $dis['early_2']!='' && $dis['dis_exp_3']>=$Da_today)//
					{
					...
					if($dis['last_1']!='' && $dis['last_2']!='' && $dis['dis_exp_4']>=$Da_today)//
					{
					...
					if($dis['long_1']!='' && $dis['long_2']!='' && $dis['dis_exp_5']>=$Da_today)//
					{
					...
					if($dis['long_3']!='' && $dis['long_4']!='' && $dis['dis_exp_6']>=$Da_today)//
					{
					...
					//------new-------------
					if($dis['early_3']!='' && $dis['early_date_3']!='' && $dis['dis_exp_7']>=$Da_today)//
					{
					...
					if(($dis['early_4']!='' && $dis['early_date_4']!='') && ($dis['dis_exp_8']>=$Da_today) || $dis['dis_exp_8']=='0000-00-00')//
					{
