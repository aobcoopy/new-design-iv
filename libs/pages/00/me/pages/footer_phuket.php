...
?>
 <div class="container <?php echo $show_phuket.' '.$f_foot;?>">
		...
		else
		{
			...
			?>
			 <h2 class=" mb f30 top"><strong><a class="tg cdf" >Where are the Best Beachfront Villas in Phuket?</a></strong></h2>
...
This will save you lots of time and research as we will only present the villas for rent that suit and are available.
		...
		?>
			 <h2 class=" mb f30 top"><strong><a class="tg cdf" >Where are the Best Villas in Phuket?</a></strong></h2> <?php /*?>Popular Luxury Villa locations Phuket<?php */?>
