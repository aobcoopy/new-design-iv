                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 col-sm-12 col-xs-12">
                               <select name="cbbSub" id="cbbSub" class="cbbSub suboption cs-select cs-skin-elastic fixscroll" >
                               		<option value="all|all" class="oldd">All Beach</option>
                               	<?php 
								...
								{
									echo '<option value="'.$lin['id']."|".$lin['parent'].'"  class="oldd hidden">'.$lin['name'].'</option>';
								}
								?>
                               </select>
                            </div>
                            ...
                            <div class="col-md-2 nopad992">
                                <button type="button" id="bt_search_1" onClick="searching1()" class="btn btn-main btn-block text_up">Search Villas</button>
                            </div>
                        </div>
                    </form>
                </div>
...
function load_subdestination(me) {
	...
	//$(".cbbSub").children('.cs-placeholder').text('All Beach');
