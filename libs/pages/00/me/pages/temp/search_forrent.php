        ...
        <div class="container">
            <div class="row ">
                ...
                <div class="col-md-2" ><?php /*?>onClick="openinig();"<?php */?>
                    ...
                    if($pa=="forrent")
                    {
                        ?><a class="navbar-brand alogo" href="/"><img id="_logo6" itemprop="logo"  src="<?php echo $url_link;?>libs/images/logo.png" class="imglogo aaa" height="50" alt="Inspiring Villas logo"></a><?php
                    }
                    else
                    {
                        ?><a class="navbar-brand" href="/"><img id="_logo6" itemprop="logo"  src="<?php echo $url_link;?>libs/images/logo.png" class="imglogo" height="50" alt="Inspiring Villas logo"></a><?php
                            ...
                            <div class="row">
                                <div class="col-md-3 col-sm-12 col-xs-12"> 
										...
										$(document).ready(function(e) {
											...
											if(c_beach=='all')
											{
												$(".cbbSub").children('.cs-placeholder').html('All Beach <label class="optin">- Optional</label>');;
											}
                                ...
                                <?php //echo $_REQUEST['sub'];?>
                                    <select name="cbbSub" id="cbbSub" class="cbbSub suboption  cs-select cs-skin-elastic fixscroll" >
                                        <option value="all|all" class="oldd" >All Beach <div class="optin">- Optional</div></option>
										<?php 
            	...
            	<div class="ztop">
                    <div class="col-md-6 col-xs-6 col-sm-6 ">
                        <select name="cbbCollection" id="cbbCollection" class="pull-right form-control cbbox ontop">
                            <option value="0" class="0"  <?php echo isset($_REQUEST['des'])?'':'selected';?>>Villa Types </option>
                             <?php 
...
function searching1()
{
	...
	$.ajax({
		...
		success: function(res){
			window.location = "<?php echo $url_link;?>"+res+".html";
		}
	});
