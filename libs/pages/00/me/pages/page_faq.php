...
<div class="container">
	<div class="row">
    	<div class="col-md-12 text-center">
               <!-- <center>-->
                <h1 class="hidden-xs ">FAQ</h1>
                <h2 class="f16 text-center ftop" style="    font-family: pt !important;">FAQ</h2><br>
                <p>Read our FAQ and find answer for common questions. If you can’t find the answer <br>feel free to <a href="?page=contact">contact us</a> via the form. For any urgent requests, please call us at +66 84 677 1551</p>
                <!--</center>-->
            </div>
