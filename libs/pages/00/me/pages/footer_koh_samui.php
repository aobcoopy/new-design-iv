...
<div class="container <?php echo $show_koh_samui.' '.$f_foot;?>">
				...
				if($_SERVER['REQUEST_URI']=='/search-rent/thailand-koh-samui/all-beach/all-price/5-7-bedrooms/all-collections/all-sort.html')
				{
                    ...
                    <h2 class=" mb f30 top"><strong><a class="tg cdf" >Where are the Best 5,6,7 Bedroom Villas in Koh Samui?</a></strong></h2>
				...
				{
					?>
                    <h2 class=" mb f30 top"><strong><a class="tg cdf" >Where are the best 8,9,10> bedroom Villas in Koh Samui?</a></strong></h2>
                    <div class="col-md-12 nopad top41">
                        <table class="table table-bordered table-striped ttb" width="100%%" border="1">
                            <thead>
                                <tr>
...
Booking well in advance will give you the most choice of villas and avoid disappointment.
				...
				{
				?>
                	<h4 class=" mb f30 top"><strong><a class="tg cdf" >Where are the Best Villas in Koh Samui?</a></strong></h4>
                 <?php
				}
				elseif($_REQUEST['cate']==6)
				{
					?>
                    <h2 class=" mb f30 top"><strong><a class="tg cdf" >Where are the Best Beachfront Villas in Koh Samui?</a></strong></h2>
					<?php
				}
				?>
                </div>
