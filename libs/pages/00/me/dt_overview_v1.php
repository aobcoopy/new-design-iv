...
<div class="pr col-md-12 nopad t_t22 minitext t5b24 hidden-xs1 f16" style="line-height:1.8">
    <span itemprop="description"  class="minitext t5b24 hidden-xs1 f16"><?php echo $bex[0]?></span><br>
...
?>
<style>
.read_more_box- > p, .read_more_box- > p > span
{
...
<div class="col-sm-12 col-md-12 nopad details" style="margin-bottom:-25px; margin-top:5px;">
    <div class="mg-single-room-txt dett det_2">
        ...
        <?php /*?><div class="read_more_coverbox"><button class="see_more" onClick="see_more_detail();"><i class="fa fa-chevron-down"></i> READ MORE</button></div><?php */?>
...
//		}, 1000);
	...
	else
	{
		...
		var re_top = testDiv.offsetTop+450;
		window.scrollTo(0, re_top);
		
		//$('html,body').animate({ 
//			scrollTop: $(".mg-footer-widget").offset().top-450//-(re_hi+190)
//		}, 0);
		//var rev_hi = $(".pos_my_reviews").height();
		
		//$('html,body').animate({ 
//			scrollTop: $(".pos_my_reviews").offset().top-500//-(re_hi+190)
//		}, 3500);
	}
	setTimeout(function(){
		setTimeout(function(){
