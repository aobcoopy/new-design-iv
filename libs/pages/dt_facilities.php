                ...
                echo '<div class="col-xs-6 col-md-4">';
                    echo '<ul class="bedr">';
						...
						if(in_array($icon_app['id'],$ar_new))
						{
							...
							echo '<li class="fo15"><image  data-src="'.json_decode($icon_app['icon'],true).'" alt="'.$icon_app['name'].'"  class="micon lazy" style="width: 34px !important;height: 32px;margin-left: -5px;" /> '.$icon_app['name'].'</li>';
						}
						else
						{
							...
							else
							{
								...
								echo '<li class="fo15"><image  data-src="/upload/icons/'.$svg[0].'.svg" alt="'.$icon_app['name'].'"  class="micon lazy" style="width: 34px !important;height: 32px;margin-left: -5px;" /> '.$icon_app['name'].'</li>';
							}
