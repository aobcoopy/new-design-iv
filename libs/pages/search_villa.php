	...
	<div class="row">
        ...
        <div class="col">
        	<ul class="mynav_2 mynav_2_mob">
                <li class="li_villa ">
                    <a href="/faq" style="border:none;">FAQ</a> <i class="fa fa-caret-down" aria-hidden="true"></i> <span class="caret"></span>
                    <ul class="d-menus ">
...
<div class="container-fluid top_photo ">
	<div class="row ">
    	<div class="col-12 nopad"><img src="<?php echo $url_link;?>upload/Artboard 120.png" alt="" width="100%" class="top_search"></div>
    </div>
</div> 
<?php
}
...
{
	?>
	<div class="container-fluid nohead_bg"></div>
    <?php
}
?>
 
<form id="forn_search_rent">
<div class="container-fluid <?php echo $bg_head;?> fixed-top text-center">
        ...
        <div class="col-12 col-md-11 col-lg-10 t_t2- align-self-end">
                ...
                <div class="row justify-content-end">
                    <div class="col-md-2 col-12 bottom10"> 
                        <select id="cbbDestination" name="cbbDestination" onChange="load_subdestination(this);" class="cbbdes2 cs-select cs-skin-elastic cbbo dbb_vd_1">
                    ...
                    <?php //echo $_REQUEST['sub'];?>
                        <select name="cbbSub" id="cbbSub" class="cbbSub suboption cs-select cs-skin-elastic fixscroll dbb_vd_1" >
                    ...
                    <div class="col-md-2 col-sm-12 col-xs-12 bottom10">
                        <div class="row">
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <select name="cbbRoom" id="cbbRoom" class="cs-select cs-skin-elastic fixscroll2 cbbo cRooms dbb_vd_1">
    ...
    <div class=" <?php echo $bread_c;?> sub_search_1 web768-">
        <div class="row justify-content-center">
            <div class="col-12">
                <div class="row">
                    
                    <div class="col-12 col-md-6 order-sm-1 order-md-2 bottom10">
                    ...
                    <div class="col-12 col-md-6 order-sm-2 order-md-1">
                        <?php 
