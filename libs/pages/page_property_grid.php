		...
		//echo '<span itemprop="brand" itemscope itemtype="http://schema.org/Brand"><span itemprop="name" class="tw tbrand" >Inspiring Villas</span></span>';
			echo '<div class="row">';//echo $row['id'];
				...
				if($row['tag']!=0)
				{
					...
					if($zz==1)
					{
						echo '<img  src="'.imageP($photo[0]['img']).'" alt="'.$img_tag.'" class="img-responsive" width="100%"></a>';//itemprop="image"
					}
					else
					{
						echo '<img data-src="'.imageP($photo[0]['img']).'" alt="'.$img_tag.'" class="img-responsive lazy" width="100%"></a>';//itemprop="image" 
					}
