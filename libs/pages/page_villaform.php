...
<?php
$id = $_REQUEST['id'];//base64_decode($_REQUEST['id']);base64_decode($_REQUEST['id']);//
//echo $id;
...
if(isset($_SESSION['auth']['user_id']))
{
    ...
    <?php /*?><div class="container top50"><br><br>
        <div class="col-12 text-center">
            <!--<button type="button" class="btn btn-primary btn_back" onClick="goback()"><i class="fa fa-arrow-left" aria-hidden="true"></i> Back</button>-->
            <button type="button" class="btn btn-success btn_back" onClick="view_form()"><i class="fa fa-search" aria-hidden="true"></i> Preview</button>
            <!--/view-villaform-BaanNicolina-abc-00123.html-->
            <br><br>
            <button class="btn btn-warning btn-lg ">Form Customer Name <?php echo $form['cus_name'];?></button>
        </div>
    </div><?php */?>
	...
	function view_form()
	{
		window.location = '/view-villaform-<?php echo str_replace(" ","",$vil_name[0]).'-'.$_REQUEST['id'];?>.html';
	}
	</script>
	<?php
}
...
<?php */?>    
			 ...
			 if(count($air)>0)
			 {
				 foreach($air as $at)
				 {
					echo '<tr>';
						...
						echo '<td ><div class="col-md-12 nopad"><input class="inp" type="date" name="tx_date_a" id="tx_date_a" value="'.$at['tx_date_a'].'"></div><div class="col-md-12 nopad top10"><input class="inp" type="date" name="tx_date_d" id="tx_date_d" value="'.$at['tx_date_d'].'"></div></td>';
 ...
 View</button>	</a></div>
    ...
    <?php /*?><div class="col-md-12 nopad top15"><br>
        <div class="vf_title_sub vt_undl">Complimentary Food & Beverages</div>
    </div>
    <div class="vf_title_sub">
    	<?php $cfb =  json_decode($villa_form['complimentary']); echo ($cfb!='')?$cfb:'-';?>
    </div>
    <br><?php */?>
    ...
    <input type="hidden" name="txtID" value="<?php echo $form_id;?>">
    	<div class="col-md-12 nopad top15">
            ...
            <div class="col-md-12 nopad top20"><?php echo ($breakfast['breakfast']!='')?$breakfast['breakfast']:'-';?><!--<textarea name="tx_BREAKFAST" id="tx_BREAKFAST" cols="30" rows="5" style="width:100%" readonly><?php echo $villa_form['breakfast'];?></textarea>--></div>
            <p>
            <span class="icon">
                ...
                <div class="col-md-12 nopad ">
                    <table width="100%%" border="0" class="table table-striped table-bordered">
                        <tbody>
                            <tr>
                                <td>Provisioning</td>
                                <td><?php echo ($f7c['provisioning']=='')?'Please select and attach back the provisional list with your requirements.':$f7c['provisioning'];?></td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <a href="<?php echo $f7c['wine_list_link'];?>" target="_blank" style="display:<?php echo $show_wll;?>"><button type="button" class="btn btn-primary pull-right" >View Link</button></a>
                                </td>
                            </tr>
                            <tr>
                                <td>Wine List</td>
...
<?php /*?>    <form id="v_form_7a">
    ...
    <input type="hidden" name="txtID" value="<?php echo $form_id;?>">
    	<div class="col-md-12 nopad top15">
            ...
            <div class="vf_title_sub">
            <div class="col-md-12 nopad "><textarea name="tx_BREAKFAST" id="tx_BREAKFAST" cols="30" rows="5" style="width:100%"><?php echo $villa_form['breakfast'];?></textarea></div>
            <p>
            <button type="button" class="btn btn-primary " onClick="save_BREAKFAST();"> Save</button>
            <span class="icon">
            	<i class="fa fa-check cok cok7b" aria-hidden="true"></i> <span class="tok tok7b"></span>
                <i class="fa fa-check cno cno7b" aria-hidden="true"></i> <span class="tno tno7b"></span>
            </span>
    ...
    <input type="hidden" name="txtID" value="<?php echo $form_id;?>">
    	<div class="col-md-12 nopad top15">
            ...
            <div class="vf_title_sub">
                ...
                <p><button type="button" class="btn btn-primary " onClick="save_Provisioning();"> Save</button>
                <span class="icon">
                    <i class="fa fa-check cok cok7c" aria-hidden="true"></i> <span class="tok tok7c"></span>
                    <i class="fa fa-check cno cno7c" aria-hidden="true"></i> <span class="tno tno7c"></span>
                </span>
...
<?php */?>  
    ...
    <input type="hidden" name="txtID" value="<?php echo $form_id;?>">
        ...
        <div class="col-md-12 nopad top15">
            ...
            <p class="top15 vf_title_sub">The refundable security deposit <?php echo ($villa_form['deposit']!='')?$villa_form['deposit']:'-';?><!--<input class="" type="text" name="tx_deposit" id="tx_deposit" readonly placeholder="of US$1500 " value="<?php echo $villa_form['deposit'];?>">--> <!--<button type="button" class="btn btn-primary " onClick="save_deposit();"> Save</button>-->
            <span class="icon">
    ...
    <input type="hidden" name="txtID" value="<?php echo $form_id;?>">
        ...
        <div class="col-md-12 nopad ">
            ...
            <div class="col-md-12 nopad ">Comment <?php echo ($f9['Comment']!='')?$f9['Comment']:'-';?><!--<textarea name="tx_Comment" id="tx_Comment" cols="30" rows="5" style="width:100%" placeholder="Comment" readonly><?php echo $f9['Comment'];?></textarea>--></div>
        </div>
        <p>
        <span class="icon">
