...
<div class="mg-blog-list">
    <div class="container">
        ...
        <?php /*?>	<center><h2 style="margin-top: -25px;">Inspiring Lifestyle</h2>
            ...
            <div class="col-xl-8 col-lg-8 col-md-12 cols-12">
                <main>
                    <?php 
					...
					while($row = $dbc->Fetch($sql))
					{
						...
						echo '<article class="mg-post">';
                            ...
                            $urll = "/blog/" . strtolower(str_replace(" ", "-", $row['name']) ) . ".html";
								...
								echo '<h2 class="mg-post-title top20"><a href="'.$urll.'" rel="bookmark">'.$row['name'].'</a></h2>';
            ...
            <div class="col-xl-4 col-lg-4 cols-12 ">
