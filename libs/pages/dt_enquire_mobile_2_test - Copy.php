			...
			success: function(res){
				if(res.data!=undefined)
				{
					if(res.data['val']!=undefined && res.data['val']!=0)
					{
						...
						var tax_1 = (res.data['tax_1']!='-')?res.data['tax_1']*price:0;
						var tax_2 = (res.data['tax_2']!='-')?res.data['tax_2']*price:0;
						var tax_3 = (res.data['tax_3']!='-')?res.data['tax_3']*price:0;
						var tax_4 = (res.data['tax_4']!='-')?res.data['tax_4']*price:0;
						var tax_5 = (res.data['tax_5']!='-')?res.data['tax_5']*price:0;
						...
						var total =(parseFloat(price)+parseFloat(tax_1+tax_2+tax_3+tax_4+tax_5));
						var total_price = numeral(total).format('0,0.00');
						
						var dep = numeral(res.data['deposite']).format('0,0');
						
						var dat = '';
						dat += '<div class="s_price f14">';
							//(res.data['services']!='-')?dat += '<span class="idet_mo">Services/Tax '+res.data['services']+' %</span><br>':0;
							//(res.data['vat']!='-')?dat += '<span class="idet_mo">VAT/Tax '+res.data['vat']+' %</span><br>':0;
							//(res.data['deposite']!='-')?dat += '<span class="idet_mo">Security Deposit '+dep+' '+exchange+'.</span><br>':0;
							dat += '<div class="row">';
								/*dat += '<div class="col-md-7 sh_more">';
									dat += '<span class="idet_mo">Price/night</span>';
								dat += '</div>';
								dat += '<div class="col-md-5 text-right sh_more">';
									(res.data['trueval']!='-')?dat += '<span class="idet_mo">'+exchange_sym+numeral(res.data['trueval']).format('0,0')+'</span>':0;
								dat += '</div>';*/
								
								dat += '<div class="col-xs-7 sh_more">';
									(res.data['total_night']!='-')?dat += '<span class="idet_mo">'+exchange_sym+numeral(res.data['trueval']).format('0,0')+' x '+res.data['total_night']+' nights</span><br>':0;
								dat += '</div>';
								dat += '<div class="col-xs-5 text-right sh_more">';
									(total_price_all_night!=0)?dat += '<span class="idet_mo">'+exchange_sym+numeral(total_price_all_night).format('0,0')+'</span><br>':0;
								dat += '</div>';
								
								if(res.data['deposite']!='-')
								{
									dat += '<div class="col-xs-7 sh_more">';
										dat += '<span class="idet_mo">Security Deposit</span>';
									dat += '</div>';
									dat += '<div class="col-xs-5 text-right sh_more">';
										dat += '<span class="idet_mo">'+exchange_sym+dep+'</span>';
									dat += '</div>';
								}
								...
								if(res.data['tax_1']!='-')
								{
									dat += '<div class="col-xs-8 sh_more">';
										dat += '<span class="idet_mo">'+res.data['tax_1_txt']+'% service charge & vat</span>';
									dat += '</div>';
									dat += '<div class="col-xs-4 text-right sh_more">';
										dat += '<span class="idet_mo">'+exchange_sym+numeral(tax_1).format('0,0.00')+'</span>';
									dat += '</div>';
								}
								...
								{
									dat += '<div class="col-xs-8 sh_more">';
										dat += '<span class="idet_mo">'+res.data['tax_2_txt']+'% service charge & Taxes.</span>';
									dat += '</div>';
									dat += '<div class="col-xs-4 text-right sh_more">';
										dat += '<span class="idet_mo">'+exchange_sym+numeral(tax_2).format('0,0.00')+'</span>';
									dat += '</div>';
								}
								...
								{
									dat += '<div class="col-xs-8 sh_more">';
										dat += '<span class="idet_mo">'+res.data['tax_3_txt']+'% service charge</span>';
									dat += '</div>';
									dat += '<div class="col-xs-4 text-right sh_more">';
										dat += '<span class="idet_mo">'+exchange_sym+numeral(tax_3).format('0,0.00')+'</span>';
									dat += '</div>';
								}
								...
								{
									dat += '<div class="col-xs-8 sh_more">';
										dat += '<span class="idet_mo">'+res.data['tax_4_txt']+'% tax</span>';
									dat += '</div>';
									dat += '<div class="col-xs-4 text-right sh_more">';
										dat += '<span class="idet_mo">'+exchange_sym+numeral(tax_4).format('0,0.00')+'</span>';
									dat += '</div>';
								}
								...
								{
									dat += '<div class="col-xs-8 sh_more">';
										dat += '<span class="idet_mo">'+res.data['tax_5_txt']+'% vat</span>';
									dat += '</div>';
									dat += '<div class="col-xs-4 text-right sh_more ">';
										dat += '<span class="idet_mo">'+exchange_sym+numeral(tax_5).format('0,0.00')+'</span>';
									dat += '</div>';
								}
								
								dat += '<div class="col-xs-12 "><div class="col-xs-12 p_box"></div></div>';
								
								dat += '<div class="col-xs-7 f14">';
									dat += '<strong>Estimated Price</strong>';
								dat += '</div>';
								dat += '<div class="col-xs-5 text-right f14">';
