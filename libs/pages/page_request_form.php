...
<?php /*?><div class="mg-page-titles top68"><!--parallax-->
    ...
    <img class="lazy web" src="../../upload/contactus/top.jpg" alt="inspiringvillas cover" width="100%" >
        <div class="row">
...
<div class=""><?php  include "libs/pages/search.php";?></div>
...
<div class="container top30">
	<div class="row">
        ...
        <h4 class=" text-center">Ask Our Specialists</h4>
        <div class="desc_con text-center">Please fill the information via the following form with your information. One of our villa specialists will be in touch with you shortly to assist you in finding the villa for your holday which match your requirements the most. For urgent or last minute requests, please call us at HongKong Line <a href="tel:+85281986765">+852-8198-6765</a> or Thailand Line <a href="tel:+66846771551">+66-84-677-1551</a></div>
        </div>
    </div>
    <div class="row top30">
    <div class="col-xs-12 col-md-12">
    	<form id="request_form" class="clearfix">
        	<div class="row">
                <div class="col-md-6">
                    <label for="full-name">First Name <span class="cred">*</span></label>
                    <input type="text" class="form-control" id="f_name" name="f_name">
                </div>
                <div class="col-md-6">
                    <label for="full-name">Last Name <span class="cred">*</span></label>
                    <input type="text" class="form-control" id="l_name" name="l_name">
                </div>
                
                <div class="col-md-6">
                    <label for="full-name">Email<span class="cred">*</span></label>
                    <input type="text" class="form-control" id="tx_email" name="tx_email" onKeyUp="lower_text(this)">
                </div>
                <div class="col-md-6">
                    <label for="full-name">Phone - for WhatsApp - it’s quicker!<span class="cred">*</span></label>
                    <div class="row">
                    	<div class="col-md-4">
                        	 <select name="countryCode2" id="countryCode2" class="form-control " >
                        ...
                        <div class="col-md-8">
                        	<input type="text" class="form-control" id="tx_tel" name="tx_tel">
                        </div>
                    </div>
                </div>
                
                <div class="col-md-6">
                    <label for="full-name">Arrival <!--<span class="cred">*</span>--></label>
                    <input type="date" class="form-control" id="Arrival" name="Arrival" value="<?php echo date("Y-m-d");?>" style="-webkit-appearance: none;   ">
                </div>
                <div class="col-md-6">
                    <label for="full-name">Departure<!--<span class="cred">*</span>--></label>
                    <input type="date" class="form-control" id="Departure" name="Departure" value="<?php echo date("Y-m-d");?>" style="-webkit-appearance: none;   ">
                </div>
                
                <div class="col-md-6">
                    <label for="full-name">Destination <span class="cred">*</span></label>
                    <select class="form-control" name="cbb_destination" id="cbb_destination">
                    	<option value="0">-Select-</option>
                    	<?php 
						$sql = $dbc->Query("select * from destinations where status > 0 and parent IS NULL AND num_properties > 0  order by name asc");
                ...
                <div class="col-md-6">
                    <label for="full-name">Number of Adults <span class="cred">*</span></label>
                    <select class="form-control" name="cbb_Adults" id="cbb_Adults">
                    	<option value="0">-Select-</option>
						<?php
                        for($i=1;$i<=20;$i++)
						{
                ...
                <div class="col-md-6">
                    <label for="full-name">Number of Children (12 years old and below)</label>
                    <select class="form-control" name="cbb_Children" id="cbb_Children">
                    	<option value="0">-Select-</option>
						<?php
                        for($i=1;$i<=10;$i++)
						{
                ...
                <div class="col-md-6">
                    <label for="full-name">Required Number of Bedrooms <span class="cred">*</span></label>
                    <select class="form-control" name="cbb_Bedrooms" id="cbb_Bedrooms">
                    	<option value="0">-Select-</option>
						<?php
                        for($i=1;$i<=10;$i++)
						{
                ...
                <div class="col-md-12">
                	<label for="full-name">Additional Message/Comments:</label>
                    <textarea type="date" class="form-control"  rows="5" id="Message" name="Message"></textarea>
                </div>
                
                <div class="col-md-2"><button type="button" onClick="sent_request();" class="btn btn-dark-main2 pull-right">Submit Request</button></div>
            </div>
        </form>
...
function sent_request()
{
	...
	else if($("#cbb_destination").val()=='0')
	{
		$(".textalert").text("* Please fill your data");//alert("Please fill your data");
		$("#cbb_destination").focus();
		return false;
	}
	else if($("#cbb_Adults").val()=='0')
	{
		$(".textalert").text("* Please fill your data");//alert("Please fill your data");
		$("#cbb_Adults").focus();
		return false;
	}
	else if($("#cbb_Bedrooms").val()=='0')
	{
		$(".textalert").text("* Please fill your data");//alert("Please fill your data");
		$("#cbb_Bedrooms").focus();
		return false;
	}
	else if($("#cbbCountry").val()=='0')
	{
		$(".textalert").text("* Please fill your data");//alert("Please fill your data");
		$("#cbbCountry").focus();
		return false;
	}
	else if($("#cbb_Budget").val()=='0')
	{
		$(".textalert").text("* Please fill your data");//alert("Please fill your data");
		$("#cbb_Budget").focus();
		return false;
	...
	else
	{
		...
		{
			$.ajax({
				url:"libs/actions/action-send-request-form.php",
				type:"POST",
				dataType:"json"	,
