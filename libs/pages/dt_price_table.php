...
//----16   
if($pri['pr_discount_16']!='' && $pri['pr_from_16']!='0000-00-00' && $pri['pr_to_16']!='0000-00-00')
{
	$exp_dates = $pri['pro_exp_16'];
	if($exp_dates>=$Da_today && $exp_dates!='0000-00-00' && $exp_dates!='')
	{
		$show_pro=true;
	}
        ...
        echo '<div class="row bgblu">';
           echo '<div class="col-md-12 ">';
                echo '<ul class="bedr ">';
					...
					//----16  
                     if($pri['pr_discount_16']!=''  && $pri['pr_from_16']!='0000-00-00' && $pri['pr_to_16']!='0000-00-00')//&& $pri['pr_free']!=''
                    {
						$exp_dates = $pri['pro_exp_16'];
						if($exp_dates>=$Da_today && $exp_dates!='0000-00-00' && $exp_dates!='')
						{
