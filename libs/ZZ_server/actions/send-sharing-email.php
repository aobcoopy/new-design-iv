<?php 
	...
	$id = $_REQUEST['id'];
	$link - $_REQUEST['links'];
	$yacht = $dbc->GetRecord("yacht","*","id='".$id."'");
	
	$img_photo = json_decode($yacht['photo'],true);
	$img_hr = json_decode($yacht['img_9'],true);
	$name = str_replace(" ","_",$yacht['name']);
	
		$strTo = $_REQUEST['email'];//.",aobcoopy@gmail.com";
		$strHeader = "Content-type: text/html; charset=UTF-8\r\n"; // or UTF-8 //
		$strHeader.= "From: rsvn@inspiringvillas.com";
		$strSubject = $yacht['name'];
	...
	<div style='padding:0px; background:#fff; border:0px solid #CDCDCD;width:600px;margin:auto;'>
			...
			<center>
				<h2>Thank you for your sharing</h2>
			</center>
			<div class='detail' style='font-size: 15px;padding:0px 10px;'><br>
				
				<strong>Yacht details</strong><br><br>
				<img src='https://www.inspiringvillas.com/".$img_photo."' width='100%' style='margin-bottom:15px;'><br>
				
				<strong>Name</strong> : ".$yacht['name']."<br>
				<strong>description</strong> : ".$yacht['detail']."<br>
				<strong>price</strong> : ".number_format($yacht['price'],2)."THB<br>
				<strong>Link</strong> : <a href='https://www.inspiringvillas.com/item-yacht-".$yacht['id']."-".$name.".html' style='cursor:pointer'>https://www.inspiringvillas.com/yacht-".$yacht['id']."-".$name.".html</a><br>
				
				<a href='https://www.inspiringvillas.com/".$img_hr."' style='cursor:pointer'>
			   	<button class='fine' style='background: #112845; width: 100%;color: #fff;border: none;padding: 10px;margin-bottom:15px;cursor:pointer;'>View Brochure</button>
			    </a>
