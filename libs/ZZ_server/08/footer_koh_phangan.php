<?php  //echo $f_foot;?>
<?php
if($_SERVER['REQUEST_URI']=='/search-rent/thailand-koh-phangan/all-beach/all-price/all-bedrooms/all-collections/all-sort.html')
{
	?>
     <div class="container-fluid  webss padtop50 new_foot  "></div><br><br>
        <div class="container ">
        <h2 class=" mb f30 top"><strong>Koh Phangan villas for large groups</strong></h2>
    ...
    <br><br><br>
        ...
        <h3 class=" mb f30 top top41"><strong>The Beauty of Koh Phangan Villas for rent</strong></h3>
        <div class="col-md-12 nopad top41 f18">
    ...
    <br><br><br>
        ...
        <h3 class=" mb f30 top top41"><strong>The Group Experience in Koh Phangan luxury villas</strong></h3>
        <div class="col-md-12 nopad top41 f18">
    ...
    <br><br>
    So next time you’re traveling with a group to the island of Koh Phangan, <a href="/search-rent/thailand-koh-samui/all-beach/all-price/all-bedrooms/all-collections/all-sort.html" class="blu">Koh Samui Villas for rent</a> or <a href="/search-rent/thailand-phuket/all-beach/all-price/all-bedrooms/all-collections/all-sort.html" class="blu">Phuket holiday villas</a> explore our collection of villas to make your holiday home. Here you’ll make memories that your group talks about for years, creating a vacation of luxury, adventure and warmth. Find a villa that is perfect for you, and we will make sure every detail is crafted for your tastes and every day is full of new experiences in paradise.
    <br><br><br><br>
        </div>
    </div>
	<?php
...
if($_SERVER['REQUEST_URI']=='/search-rent/thailand-koh-phangan/all-beach/all-price/all-bedrooms/seaview-villas/all-sort.html')
{
    ...
    <br><br>
        <div class="container ">
        <h2 class=" mb f30 top"><strong>Experience Koh Phangan Seaview Villas for Rent</strong></h2>
        <div class="col-md-12 nopad top41 f18">
        ...
        <h3 class=" mb f30 top top41"><strong>Wellness and Recreation in a Tropical Setting</strong></h3>
        <div class="col-md-12 nopad top41 f18">
    ...
    <br><br><br>
        ...
        <h3 class=" mb f30 top top41"><strong>Entertainment for Everyone</strong></h3>
        <div class="col-md-12 nopad top41 f18">
