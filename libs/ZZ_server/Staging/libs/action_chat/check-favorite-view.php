<?php
	...
	if(count($_SESSION['favorite'])>0)
	{
		...
		<center>
		<h1 class="mtop255" style="    text-transform: uppercase;" > Interested in one of your favorite villas?</h1>
		...
		//				echo '</pre>';
						...
						{	krsort($_SESSION['favorite']);
							foreach($_SESSION['favorite'] as $idv)
							{
