...
<?php
    ...
    <!----------------------------------------------- style ------------------------------------------------------------------------>
    <link href="<?php echo $url_link;?>libs/css/v5/new_design31.css" rel="stylesheet"> 
    <link href="<?php echo $url_link;?>libs/css/v5/new_design_responsive31.css" rel="stylesheet"> 
    <!----------------------------------------------- style ------------------------------------------------------------------------>
