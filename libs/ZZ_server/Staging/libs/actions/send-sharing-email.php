<?php 
	...
	<div style='padding:0px; background:#fff; border:0px solid #CDCDCD;width:600px;margin:auto;'>
			...
			<div class='detail' style='font-size: 15px;padding:0px 10px;'><br>
				...
				<strong>Link</strong> : <a href='https://www.inspiringvillas.com/yacht-".$yacht['id']."-".$name.".html' style='cursor:pointer'>https://www.inspiringvillas.com/yacht-".$yacht['id']."-".$name.".html</a><br>
