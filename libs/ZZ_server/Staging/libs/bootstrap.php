...
<?php /*?>    <title><?php echo $title_tag." - InspiringVillas.com";?></title> 
<?php */?>    
<?php 
    ...
    <link href="<?php echo $staging ?>libs/css/v5/bootstrap_5/bootstrap.min.css" rel="stylesheet"> 
	...
	<?php
        ...
        <link rel="preload stylesheet" href="<?php echo $AWS_S3_link;?>libs/css/datepicker.css" >
    <?php
        }
    ...
    <?php
		...
		{
        ?>
        <link href="<?php echo $staging;?>libs/css/v5/style.css?v=00202" rel="stylesheet">
        <link href="<?php echo $staging;?>libs/css/v5/a_style.css?v=00101" rel="stylesheet"> 
...
elseif($page == 'recently' || $page == 'contact' || $page == 'privacy' || $page == 'terms' || $page == 'about' || $page == 'service' )//
{
...
<script defer src="<?php echo $staging;?>libs/js/v5/bootstrap_5/bootstrap.min.js"></script>
