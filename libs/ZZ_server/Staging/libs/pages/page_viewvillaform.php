...
<?php
$id = $_REQUEST['id'];//base64_decode($_REQUEST['id']);
//echo $id;
...
<div class="container back_form">
    ...
    <input type="hidden" name="txtID" value="<?php echo $form_id;?>">
        ...
        <div class="col-md-12 nopad top15">
			...
			<dl class="row top15 dl-horizontal">
                ...
                <!--<dt class="col-sm-2- text-right">Google map</dt> <dd class="col-sm-10-"><?php echo $inf['map'];?></dd>-->
    ...
    <form id="v_form_4">
        ...
        <div class="col-md-12 nopad top15">
        	<div class="vf_title vt_undl">Transfers Informations</div><br>
        	<div class="grids">
					 ...
					 foreach($air['arrival'] as $at)
					 {
						 ...
						 <div class="alert alert-success col-md-12 arrival" role="alert">
                            ...
                            <dl class="row">
                                ...
                                <dd class="col-sm-8"><?php echo $at['tx_sname_a'];?></dd>
                                <dt class="col-sm-4">Date</dt>
                                <dd class="col-sm-8"><?php echo $at['tx_date_a'];?></dd>
                                <dt class="col-sm-4">Airport/Hotel</dt>
                                <dd class="col-sm-8"><?php echo $at['tx_airline_a'];?></dd>
                                <dt class="col-sm-4">Flight number</dt>
                                <dd class="col-sm-8"><?php echo $at['tx_flight_a'];?></dd>
                                <dt class="col-sm-4">Time</dt>
                                <dd class="col-sm-8"><?php echo $at['tx_time_a'];?></dd>
                                <dt class="col-sm-4">No. of Adults/Kids</dt>
                                <dd class="col-sm-8"><?php echo $at['tx_pass_a'];?></dd>
                                <dt class="col-sm-4">Transfer Arrangement Yes or No</dt>
                                <dd class="col-sm-8"><?php echo $at['tx_transfer_a'];?></dd>
                                <dt class="col-sm-4">Contact number and Special Request</dt>
                                <dd class="col-sm-8"><?php echo $at['tx_Contact_a'];?></dd>
                            </dl>
                        </div>
					<?php
					 }
					 ...
					 foreach($air['departure'] as $at)
					 {
						 ...
						 ?>
                            <div class="alert alert-warning col-md-12 departure" role="alert">
                                ...
                                <dl class="row">
                                <dt class="col-sm-4">Sign Name</dt>
                                <dd class="col-sm-8"><?php echo $at['tx_sname_d'];?></dd>
                                <dt class="col-sm-4">Date</dt>
                                <dd class="col-sm-8"><?php echo $at['tx_date_d'];?></dd>
                                <dt class="col-sm-4">Airport/Hotel</dt>
                                <dd class="col-sm-8"><?php echo $at['tx_airline_d'];?></dd>
                                <dt class="col-sm-4">Flight number</dt>
                                <dd class="col-sm-8"><?php echo $at['tx_flight_d'];?></dd>
                                <dt class="col-sm-4">Time</dt>
                                <dd class="col-sm-8"><?php echo $at['tx_time_d'];?></dd>
                                <dt class="col-sm-4">No. of Adults/Kids</dt>
                                <dd class="col-sm-8"><?php echo $at['tx_pass_d'];?></dd>
                                <dt class="col-sm-4">Transfer Arrangement Yes or No</dt>
                                <dd class="col-sm-8"><?php echo $at['tx_transfer_d'];?></dd>
                                <!--<dt class="col-sm-4">Contact number and Special Request</dt>
            ...
            <p><strong>Special Request:</strong> <?php echo json_decode($form['special_request']);?></p>
        </div>
    </form>
    ...
    <input type="hidden" name="txtID" value="<?php echo $form_id;?>">
        <div class="col-md-12 nopad top15">
            ...
            <div class="col-md-12 nopad "><input type="tel" name="tx_phone" id="tx_phone" style="width:100%" value="<?php echo $villa_form['phone'];?>">
        ...
        <div class="col-md-12 nopad top15">
            ...
            <div class="col-md-12 nopad top15">
				...
				<div class="vf_title_sub">
                    ...
                    <div class="col-md-8 nopad "><a  href="<?php echo $villa_form['tx_food_link'];?>" target="_blank" ><button <?php echo $dis_pl;?> class="btn btn-primary"><i class="fa fa-list" aria-hidden="true"></i>
 View</button>	</a></div>
    	...
    	<div class="col-md-12 nopad top15">
            ...
            <div class="vf_title_sub">
                <div class="col-md-12 nopad ">
                    ...
                    File : <a href="<?php echo ($f7c['file_path']!='')?$f7c['file_path']:'#';?>" target="_blank"> <?php echo ($f7c['filename']!='')?$f7c['filename']:'';?></a>
                </div>
                <p>
                <span class="icon">
    ...
    <input type="hidden" name="txtID" value="<?php echo $form_id;?>">
        ...
        <div class="col-md-12 nopad top15">
            ...
            <p class="top15 vf_title_sub">The refundable security deposit <?php echo $villa_form['deposit'];?>
