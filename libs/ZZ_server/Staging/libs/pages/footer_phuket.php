...
Planning and booking well in advance will give you the most villas to choose from.
        ...
        <div class="col-md-12 nopad top41">
        <h4 class=" mb f30 top"><strong><?php /* ?><a class="tg cdf" ><?php */?><?php echo $this_year;?> Phuket Beachfront Villa Cost Survey<?php /*?></a><?php */?></strong></h4>
            <div class="col-md-12 nopad top21 f18">
                ...
                In <?php echo $last_year;?> the average rental value of one room in a beachfront villa was USD$379++ per night<br>
