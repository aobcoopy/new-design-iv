...
<?php */?>
<?php /*?>--------------------new-----------------------<?php */?>
<?php /*?><div id="mega-sliders" class="carousel slide top48" data-ride="carousel">
    <!-- Wrapper for slides -->
...
<div id="main_slide" class="carousel slide top48" data-ride="carousel">
  <div class="carousel-inner">
	...
	while($row = $dbc->Fetch($sqls))
	{
		...
		echo '<div class="carousel-item '.$act.'">';
		 ...
		 echo '<img src="'.imageP($photo).'" class="d-block w-100" alt="inspiringvillas cover">';
		echo '</div>';
  ...
  <a class="carousel-control-prev carousel-control caro left l0-" href="#main_slide" role="button" data-slide="prev">
    <i class="fa fa-angle-left"></i>
  </a>
  <a class="carousel-control-next carousel-control caro right r0-" href="#main_slide" role="button" data-slide="next">
        ...
        <div class="row justify-content-center">
            <div class="col-sm-12 col-md-12 col-lg-8 col-xl-8 ">
				...
				while($r_cate = $dbc->Fetch($sql_cate))
				{
					...
					if($zz<1){$cal2="bottom20";}else{$cal2="";}
					$zz++;
					//echo '<div class="row row-cols-1 row-cols-md-2 row-cols-lg-3 row-cols-xl-3">';
						echo '<div class="col '.$cal.' '.$cal2.'">';//col-sm-6 col-md-6
							if($r_cate['id']==4)
							{
							...
							echo '<a href="'.$ht_links.'">';
								echo '<div class="col-md-12 col-sm-12 col-xs-12 boxpho nopad">';
									if($zz<3)
									{
							...
							echo '<div class="row no-gutters">'; 
								...
								echo '<div class="col-12 col-sm-6 col-md-6 bpl top10 web576" onclick="window.location.href=\'' . $phuket_link . '\'" style="cursor: pointer;" id="locationBox">';
									echo '<div class="col-md-12 col-sm-12 col-xs-12  boxbot  f14">';
										echo '<div style="text-align: center;"><a class="locationText" id="locationText" href="' . $phuket_link . '">Phuket '.$ca_name[0].'</a></div>';								
									echo '</div>';
								echo '</div>'; 
								
								echo '<div class="col-12 col-sm-6 col-md-6 bpr top10 web576"  onclick="window.location.href=\'' . $koh_samui_link . '\'" style="cursor: pointer;" id="locationBox">';
								...
								echo '<div class="col-12 col-sm-6 col-md-6  top10 mob576" onclick="window.location.href=\'' . $phuket_link . '\'" style="cursor: pointer;" id="locationBox">';
									echo '<div class="col-md-12 col-sm-12 col-xs-12  boxbot  f14">';
										echo '<div style="text-align: center;"><a class="locationText" id="locationText" href="' . $phuket_link . '">Phuket '.$ca_name[0].'</a></div>';								
									echo '</div>';
								echo '</div>'; 
								
								echo '<div class="col-12 col-sm-6 col-md-6  top10 mob576"  onclick="window.location.href=\'' . $koh_samui_link . '\'" style="cursor: pointer;" id="locationBox">';
									echo '<div class="col-md-12 col-sm-12 col-xs-12  boxbot nopad f14 '.$rcate.' '.$small_font.'">';
										echo '<div style="text-align: center;"><a class="locationText" id="locationText" href="' . $koh_samui_link . '">Koh Samui '.$ca_name[0].'</a></div>';
									echo '</div>';
								echo '</div>';
							...
							/*echo '<div class="row  row-cols-2 row-cols-md-2 row-cols-lg-2 row-cols-xl-2  bottom20">'; 
							
								echo '<div class="col bpl top10" onclick="window.location.href=\'' . $phuket_link . '\'" style="cursor: pointer;" id="locationBox">';
									echo '<div class="col-md-12 col-sm-12 col-xs-12 boxbot nopad f14">';
										echo '<div style="text-align: center;"><a class="locationText" id="locationText" href="' . $phuket_link . '">Phuket '.$ca_name[0].'</a></div>';								
									echo '</div>';     
								echo '</div>';  
								
								echo '<div class="col  bpr top10" onclick="window.location.href=\'' . $koh_samui_link . '\'" style="cursor: pointer;" id="locationBox">';
									echo '<div class="col-md-12 col-sm-12 col-xs-12 boxbot nopad f14 '.$rcate.' '.$small_font.'">';
										echo '<div style="text-align: center;"><a class="locationText" id="locationText" href="' . $koh_samui_link . '">Koh Samui '.$ca_name[0].'</a></div>';
									echo '</div>';
								echo '</div>';                           
    ...
    <div class="container">
        <div class="row justify-content-center">
        	<div class="col-md-12 top30">
                    ...
                    <div class="col-md-12 mob top30 text-center">
        ...
        <div class="row">
            ...
            <div class="col-sm-4">
                <div class="mg-feature"  style="border-right: 1px solid #ddd;">
                    ...
                    <p class="f16"  style="font-family:pt !important;">There is truly something for everyone. Our staff can find the perfect holiday villa match for you, helping you to discover the location and villa that best suits your needs. We will show you which beach (in Phuket or Koh Samui) and villa are perfect for your next vacation.
                   </p>
                </div>
            </div>
            <div class="col-sm-4">
