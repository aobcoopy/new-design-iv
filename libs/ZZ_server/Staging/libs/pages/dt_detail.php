            ...
            foreach(json_decode($room['features']) as $feat)
            {
                ...
                echo '<div class="col-xs-6 col-md-4 ">';
                    echo '<ul class="bedr">';
						...
						echo '<li class="f18t"><image  data-src="' . S3_BUCKET_URL . '/upload/icons/'.$svg[0].'.svg" alt="'.$icon_feat['name'].'"  class="micon lazy" style="width: 34px !important;height: 32px;margin-left: -5px;" /> '.$icon_feat['name'].'</li>';
                    echo '</ul>';
                echo '</div>';
                $b++;
                if(($b%3)==0)
