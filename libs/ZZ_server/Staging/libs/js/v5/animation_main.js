...
$(window).scroll(function () {
	...
	*/
	...
	var myPosition = $(".bottom_our_sun").offset().top-300;
	var ele0 = $(".yacht_tt,.yacht_des");
	var ele1 = $(".yacht_tt");
	var ele2 = $(".yacht_des");
	if ($(this).scrollTop() > myPosition) 
	{
		$(ele0).removeClass('hidd');
		$(ele1).addClass('focus-in-contract');
		$(ele2).addClass('animate__fadeInUp');
	}
	
	var myPosition = $(".ya1").offset().top-300;
	var ele = $(".yal,.yar");
	var ele1 = $(".yal");
	var ele2 = $(".yar");
	if ($(this).scrollTop() > myPosition) 
	{
		$(ele).removeClass('hidd');
		$(ele1).addClass('tilt-in-fwd-bl');
		$(ele2).addClass('tilt-in-fwd-br');
	}
	
	var myPosition1 = $(".ex111").offset().top-300;
	var ele00 = $(".exl2,.exr2");
	var ele11 = $(".exl2");
	var ele22 = $(".exr2");
	if ($(this).scrollTop() > myPosition1) 
	{
		$(ele00).removeClass('hiddd');
		$(ele11).addClass('tilt-in-fwd-bl');
		$(ele22).addClass('tilt-in-fwd-br');
	}
	//INSPIRING LIFE STYLE
	var myPosition = $(".lifestyle_box_111").offset().top-300;
