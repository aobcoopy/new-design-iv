        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-2" ><?php /*?>onClick="openinig();"<?php */?>
                    ...
                    if($pa=="forrent")
                    {
                        ?><a   class="navbar-brand alogo" href="/"><img id="_logo6"  src="<?php echo $url_link;?>libs/images/logo.png" class="imglogo aaa" width="86" height="60" alt="Inspiring Villas logo"></a><?php
                    }
                    else
                    {
                        ?><a class="navbar-brand" href="/"><img id="_logo6" itemprop="logo"  src="<?php echo $url_link;?>libs/images/logo.png" class="imglogo" width="86" height="60" alt="Inspiring Villas logo"></a><?php
                    }
                    ?>
                    </div>
