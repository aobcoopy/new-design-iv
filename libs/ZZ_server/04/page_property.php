...
//                                            }
										...
										else
										{
											if($zz=='5' )
											{
												...
												echo '<div class="villa_boxs_mini photo_banner mob "><img src="/upload/search/mm111.jpg" class="wid_100" width="480" height="235" alt="CONCIERGE OFFER"></div>';
...
//                                       echo $all_urls;
                                    ...
                                    <?php
                                        ...
                                        <div class="loadd" style="display:none;">
                                            <img src="<?php echo S3_BUCKET_URL ?>/upload/loading.gif" width="50" height="50" alt="Loading inspiring villa"><br>Loading..
                                        </div>
