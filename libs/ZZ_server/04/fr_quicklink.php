...
<div class="col-md-12 col-sm-12 col-xs-12 nopad ql <?php echo $ql_hid;?> ">
    ...
    <div class="col-md-12 col-sm-12 col-xs-12 blo text-center f15t">
		...
		{*/
			...
			/*$ql_link = '<strong>Please note</strong> - <span class="inss">
			All the villas directly on the beachfront villas Phuket are below. <br>Nearly all the villas for rent in Phuket are
			...
			echo $ql_link;*/
		/*}
		else*/if($uurrll == "/search-rent/thailand-phuket/all-beach/all-price/all-bedrooms/wedding-villas/all-sort.html")
		{
		...
		{
			//$ql_link = '<span class="inss">Congratulations. Thailand Wedding Villas planning available.<br>Enjoy browsing the villas & read <a onclick="gotopositions();">how we work</a>.</span>';
			$ql_link = '<span class="inss">Nearly all the villas in Phuket are <a href="/search-rent/thailand-phuket/all-beach/all-price/all-bedrooms/seaview-villas/all-sort.html">seaview villas</a> in the hills above the beaches.<br>
There are just a few Phuket villas with direct access on the <a href="/search-rent/thailand-phuket/all-beach/all-price/all-bedrooms/beachfront-villas/all-sort.html">beachfront</a>.</span>';
			//echo $ql_link;
		}
		?>
    </div>
