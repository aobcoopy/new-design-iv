		...
		else
		{
			...
			{*/
				if($dbc->Insert("contact_us",$data))
				{
					...
					$str_name = $fullname." IV Enquiry ".$villa_name;
			...
			//		}
					...
					{
						$strTo_2 = "rsvn@inspiringvillas.com,d74agk7a@robot.zapier.com";
					}
					...
					$str_name = strtolower($userTrimFirstName)." IV Enquiry ".$villa_name;
					$strSubject_2 = "=?utf-8?B?".base64_encode($str_name)."?=";
					...
					if($prop['email']!='')
					{
						...
						$str_name_3 = strtolower($userTrimFirstName)." IV Enquiry ".$villa_name;
