                ...
                <div class="col-md-6">
					...
					foreach($decode as $img)
					{
                       echo '<div class="col-md-4 pho">';
							...
							$nex_3 = str_replace("_upload_property_","_",$nex_2);
							$nex_4 = str_replace("-","",$nex_3);
							$nex_5 = str_replace("(","",$nex_4);
							$nex_6 = str_replace(")","",$nex_5);
							$nex_7 = str_replace("_jpeg","",$nex_6);
							$nex_8 = str_replace("_jpg","",$nex_7);
							$nex = 'b'.$nex_8;
							
							$pname = $img['name'];
							$posi = ($img['posi']!='')?$img['posi']:$_REQUEST['id'].'-'.$x;
							...
							//echo '<input type="text" class="ne_position_xx"  value="'.$posi.'">';
...
function add_photo_bedroom(me,pname)
{
	...
	var posi_x = $(me).parent().find($('.ne_position_xx')).val();
	var a='';
	a+= '<div class="col-md-4 pho_2">';
		...
		//a+= '<input type="text" class="ne_position_xx"  value="'+posi_x+'">';
...
function remove_bedroom_pt(me)
{
	...
	//var posi = $(me).parent().find($('.ne_position_xx')).val();
	//alert(posi);
