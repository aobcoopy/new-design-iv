  	...
  	<div class="modal-dialog  "  style="width:90%;">
    	...
    	<div class="modal-content">
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            ...
                            <button type="button" class="btn btn-primary mybutt" onClick="fn.app.properties.properties.upload_photo()">Upload</button>
					...
					foreach($decode as $img)
					{
                       echo '<div class="col-md-2 pho">';
							...
							echo '<button type="button" class="btn btn-danger" style="width:100%" onclick="fn.app.properties.properties.remove_photo_edit(this);">';
			...
			<div class="modal-footer">
				...
				<button type="button" class="btn btn-primary mybutt" onClick="fn.app.properties.properties.save_photo_book();">Save</button>
			</div>
	  	</div><!-- /.modal-content -->
		</form>
