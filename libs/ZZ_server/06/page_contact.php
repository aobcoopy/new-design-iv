...
For any urgent requests, please call us at <a href="tel:+85281986765" style=" color:#4b565b;">+852 8198 6765</a><br><br>
                    ...
                    <div class="col-xs-12 col-md-12" style="position:relative; z-index:100;">
                    <h1 class=" text-center">Contact Us</h1>
                    	<div class="col-xs-12 col-md-4 con_top_box">
                        	<div class="con_inside_box con_inside_box_1"></div>
                            <div class="con_inside_tt">
                                request form<br>
                                <a href="/request-form"><div class="btn__link_request_form">click here &gt;</div></a>
                            </div>
                        </div>
                        <div class="col-xs-12 col-md-4 con_top_box">
                        	<div class="con_inside_box con_inside_box_2"></div>
                            <div class="con_inside_tt">
                            	Reach Us <br>
                            	<a href="https://api.whatsapp.com/send?phone=<?php echo $whatsapp;?>" rel="nofollow" target="_blank" class="alignnone" style="margin: 0px; padding: 0px; display: inline-block; position: relative; overflow: hidden;">
                                    <img class="lazy" data-src="../../upload/whatsapp.png" alt="Inspiring Villas Whatsapp" width="40px">
                                </a>
                                <a href="http://m.me/inspiringvillas/" rel="nofollow" class="alignnone"  target="_blank" style="margin: 0px; padding: 0px; display: inline-block; position: relative; overflow: hidden;">
                                    <img class="lazy" data-src="../../upload/mass.png" alt="Inspiring Villas Messanger" width="35px">
                                </a>
                                <a href="http://line.me/ti/p/@199bkzqs" rel="nofollow" target="_blank" class="alignnone" style="margin: 0px; padding: 0px; display: inline-block; position: relative; overflow: hidden;margin-left: 3px;">
                                    <img class="lazy" data-src="../../upload/lineico.png" alt="Inspiring Villas Line" width="35px">
                                </a>
                            </div>
                        </div>
                        <div class="col-xs-12 col-md-4 con_top_box">
                        	<div class="con_inside_box con_inside_box_3"></div>
                            <div class="con_inside_tt">
                                email us<br>
                                <a href="mailto:info@inspiringvillas.com" class="alignnone" target="_blank" style="margin: 0px; padding: 0px; display: inline-block; position: relative; overflow: hidden;">
                                    <img class="lazy" data-src="../../upload/gmail.png" alt="Inspiring Villas Gmail" width="40px">
                                </a>
                            </div>
                        </div>
                        
                    </div>
                    <div class="col-md-12 top20">For a general question or enquiries please submit the form below by providing your name & email & contact number - we'll get straight back to you!. For any urgent requests, please call us at HongKong Line <a href="tel:+85281986765">+852-8198-6765</a> or Thailand Line <a href="tel:+66846771551">+66-84-677-1551</a></div>
                    
					<div class="col-xs-12 col-md-8 viewform"><br>
					...
					<div class="col-xs-12 col-md-4 nopad"><br><br><br>
...
.con_inside_box_1
{
	background: url(../../../upload/contactus/11.jpg) ;
...
.con_inside_box_2
{
	background: url(../../../upload/contactus/2.jpg) ;
    background-size: cover;
    background-repeat: no-repeat;
    background-position: center;
}
.con_inside_box_3
{
	background: url(../../../upload/contactus/3.jpg) ;
    background-size: cover;
    background-repeat: no-repeat;
    background-position: center;
}
...
.con_top_box:first-child
{
	padding-left:0px;
}
.con_top_box:last-child
{
	padding-right:0px;
}
.con_inside_box
