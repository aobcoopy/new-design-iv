<div class="col-md-12">
	<div class="panel panel-default">
        ...
        <ul class="nav nav-tabs" role="tablist">
            <li role="presentation" class="active"><a href="#Bali" aria-controls="Bali" role="tab" data-toggle="tab">Bali</a></li>
        </ul>
        ...
        <div class="tab-content">
            <div role="tabpanel" class="tab-pane active" id="Phuket"><br>
            	<div class="table-responsive">
                    <table id="tblSlide" class="tblSlide_3 table table-striped table-bordered datatable">
                        <thead>
                            <tr>
                                <th>
...
.tblSlide_3 tbody tr ,.imgas,#tblSlide tbody tr 
{
	height:100px !important;
}
