											...
											echo '<div class="">';
												echo '<div class="row">';
													echo '<div class="col-sm-8">';
														echo '<input type="text" class="form-control" name="tx_main_e[]" value="'.$wic1.'">';
													echo '</div> ';
                                    ...
                                    <?php 
										...
										foreach($what_ic6 as $wic6)
										{
											echo '<div class="">';
												echo '<div class="row">';
													echo '<div class="col-sm-8">';
														echo '<input type="text" class="form-control" name="tx_available_e[]" value="'.$wic6.'">';
													echo '</div> ';
													echo '<div class="col-sm-2">';
														echo '<button type="button" class="btn btn-danger" onClick="$(this).parent().parent().remove();"><i class="fa fa-remove"></i></button>';
													echo '</div> <br> ';
                                    ...
                                    <?php 
										...
										foreach($what_ic7 as $wic7)
										{
											echo '<div class="">';
												echo '<div class="row">';
													echo '<div class="col-sm-8">';
														echo '<input type="text" class="form-control" name="tx_House_e[]" value="'.$wic7.'">';
													echo '</div> ';
													echo '<div class="col-sm-2">';
														echo '<button type="button" class="btn btn-danger" onClick="$(this).parent().parent().remove();"><i class="fa fa-remove"></i></button>';
													echo '</div> <br> ';
									...
									if($properties['wiic']==1)
									{
										...
										foreach($what_ic2 as $wic2)
										{
											echo '<div class="">';
													echo '<div class="row">';
														echo '<div class="col-sm-8">';
															echo '<input type="text" class="form-control" name="tx_transfer_e[]" value="'.$wic2.'">';
														echo '</div> ';
														echo '<div class="col-sm-2">';
															echo '<button type="button" class="btn btn-danger" onClick="$(this).parent().parent().remove();"><i class="fa fa-remove"></i></button>';
														echo '</div> <br> ';
									...
									if($properties['wiic']==1)
									{
										...
										foreach($what_ic3 as $wic3)
										{
											echo '<div class="">';
												echo '<div class="row">';
													echo '<div class="col-sm-8">';
														echo '<input type="text" class="form-control" name="tx_service_e[]" value="'.$wic3.'">';
													echo '</div> ';
													echo '<div class="col-sm-2">';
														echo '<button type="button" class="btn btn-danger" onClick="$(this).parent().parent().remove();"><i class="fa fa-remove"></i></button>';
													echo '</div> <br> ';
									...
									if($properties['wiic']==1)
									{
										...
										foreach($what_ic4 as $wic4)
										{
											echo '<div class="">';
												echo '<div class="row">';
													echo '<div class="col-sm-8">';
														echo '<input type="text" class="form-control" name="tx_Charge_e[]" value="'.$wic4.'">';
													echo '</div> ';
													echo '<div class="col-sm-2">';
														echo '<button type="button" class="btn btn-danger" onClick="$(this).parent().parent().remove();"><i class="fa fa-remove"></i></button>';
													echo '</div> <br> ';
									...
									if($properties['wiic']==1)
									{
										...
										foreach($what_ic5 as $wic5)
										{
											echo '<div class="">';
												echo '<div class="row">';
													echo '<div class="col-sm-8">';
														echo '<input type="text" class="form-control" name="tx_Special_e[]" value="'.$wic5.'">';
													echo '</div> ';
													echo '<div class="col-sm-2">';
														echo '<button type="button" class="btn btn-danger" onClick="$(this).parent().parent().remove();"><i class="fa fa-remove"></i></button>';
													echo '</div> <br> ';
