<?php
	include_once "apps/booking/view/dialog.booking.remove.php";
?>
<script style="text/javascript">
	
	fn.app.booking.booking.remove = function(){
	...
	$("#dialog_remove_group .btnConfirm").click(function(){
		var item_selected = $("#tblGroup").data("selected");
		$.post('apps/booking/xhr/action-remove-booking.php',{items:item_selected},function(response){
