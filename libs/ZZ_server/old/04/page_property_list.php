	...
	//echo '<span itemprop="brand" itemscope itemtype="http://schema.org/Brand"><span itemprop="name" class="tw tbrand" >Inspiring Villas</span></span>';
		...
		echo '<div class="col-xs-12 col-sm-12 col-md-12 nopad villa_boxs_inside">';
			...
			else
			{
				...
				if($zz==1)
				{
					echo '<img  src="'.imagePath($photo[0]['img']).'" alt="'.$img_tag.'" class="img-responsive middle_screen wid_100" width="368" height="192"></a>';//itemprop="image"
					//echo '<img  src="'.imageP($photo[0]['img']).'" alt="'.$img_tag.'" class="img-responsive middle_screen" width="100%"></a>';//itemprop="image"
				}
				else
				{   
					echo '<img data-src="'.imagePath($photo[0]['img']).'" alt="'.$img_tag.'" class="img-responsive middle_screen lazy wid_100" width="368" height="192"></a>';
		   ...
		   // $imgs ='';
			...
			echo '<img  src="'.imagePath($photo[0]['img']).'" alt="'.$name[0].'" class="img-responsive " width="670" height="350" style="display:none;">';//itemprop="image"
			...
			echo '<div class="col-xs-12 col-sm-7 col-md-8 web t_t33 v_details" style="margin-top:19px;">';  //-------------cheange
				...
				echo '<div class="col-xs-12 col-sm-12 col-md-12 nopad t_t33">';
					echo '<div class="col-xs-12 col-sm-12 col-md-12 nopad t_t11"><div class="mg-avl-room-title vtitle f23_2"><span >'.$name[0].'</span></div></div>';//--itemprop="name"
				echo '</div>';
						...
						echo '<div class="col-xs-12 col-sm-7 col-md-5 top15 t_t11">';  //-------------cheange
							echo '<ul>';
								echo '<li style="margin-bottom: -2px;">';
										...
										echo '<image data-src="/upload/location.svg" alt="location"  class="micon lazy" style="width: 23px !important;"/>';
								...
								echo '<li>';
									...
									if($icon_cate == "seas")
									{
										...
										echo '<image  data-src="/upload/'.$icon_cate.'.svg" alt="'.$icon_cate.'"  class="micon lazy" style="width: 28px !important;height: 32px;margin-left: -5px;" />';
										$luxu = "Luxury ";
									}
									else
									{
										//echo '<image  data-src="' . S3_BUCKET_URL . '/upload/'.$icon_cate.'.svg"  class="micon lazy" />';
										echo '<image  data-src="/upload/'.$icon_cate.'.svg" alt="'.$icon_cate.'"  class="micon lazy" />';
										$luxu = "";
									}
					...
					echo '<div class="col-xs-6 col-sm-5 col-md-3 top15 nopad t_t22">'; //-------------cheange
							echo '<ul>';
								echo '<li>';
									...
									echo '<image data-src="/upload/bed.svg" alt="bed"  class="micon lazy" />';
								...
								echo '<li>';
									...
									echo '<image data-src="/upload/team.svg" alt="team"  class="micon lazy"/>';
							...
							echo '<div class="col-xs-7 col-sm-6 col-md-6 padleft25 top10 t_t11">';
								echo '<ul>';
									echo '<li class="pdmb">';
										...
										echo '</svg>';*/
										echo '<image data-src="' . S3_BUCKET_URL . '/upload/location.svg" alt="location"  class="micon lazy" style="width: 22px !important;padding-left: 5px;"/>';
										//echo '<div class="ic_name">&nbsp;&nbsp;'.$full_location.'</div>';
									...
									if($row['cate_icon']!='')
									{
										echo '<li class="pdmb">';
											...
											if($icon_cate == "seas")
											{
												echo '<image data-src="' . S3_BUCKET_URL . '/upload/'.$icon_cate.'.svg" alt="'.$icon_cate.'"  class="micon lazy" style="width: 34px !important;height: 37px;margin-left: -5px;background: #ffcdcd00;margin-top: -8px;margin-bottom: -1px !important;" />';
												$luxu_mo = "Luxury ";
											}
											else
											{
												echo '<image data-src="' . S3_BUCKET_URL . '/upload/'.$icon_cate.'.svg" alt="'.$icon_cate.'"  class="micon lazy" />';
												$luxu_mo = "";
											}
							...
							echo '<div class="col-xs-5 col-sm-6 col-md-6 padleft251 top10 t_t22">';
								echo '<ul>';
									echo '<li class="pdmb">';
										...
										echo '</svg>';*/
										echo '<image data-src="' . S3_BUCKET_URL . '/upload/bed.svg" alt="bed"  class="micon lazy" />';
									...
									echo '<li class="pdmb">';
										...
										echo '</svg>';*/
										echo '<image data-src="' . S3_BUCKET_URL . '/upload/team.svg"  alt="team"  class="micon lazy" />';
