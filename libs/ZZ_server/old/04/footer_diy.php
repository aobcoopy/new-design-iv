		...
		<div class=" mob">
			<div class="col-md-12 pal nopad pmob ">
				<div class="col-md-12 cinside nopad">
					...
					<i class="fa fa-play-circle" onClick="popu('<?php echo $_REQUEST['des'];?>')"></i>
					<div class="imggs">
						<img class="lazy" data-src="<?php echo $url_link;?>upload/<?php echo $img_vdo;?>2.jpg" alt="<?php echo 'Phuket holiday villas';//$img_vdo;?>" width="100%" class="vdo_cov">
					</div>
				</div>
			</div>
		</div>
