...
<?php 
    ...
    <?php } else { 
			...
			'/search-rent/thailand-koh-samui/chaweng-noi/all-price/all-bedrooms/all-collections/all-sort.html',
			'/search-rent/thailand-koh-samui/bangrak-beach/all-price/all-bedrooms/all-collections/all-sort.html',
			'/search-rent/thailand-phuket/kata-beach/all-price/all-bedrooms/all-collections/all-sort.html',
			'/search-rent/thailand-phuket/natai-beach/all-price/all-bedrooms/all-collections/all-sort.html'];
...
j=d.createElement(s),dl=l!='dataLayer'?'&l='+l:'';j.async=true;j.src=
'https://www.googletagmanager.com/gtm.js?id='+i+dl;f.parentNode.insertBefore(j,f);
})(window,document,'script','dataLayer','GTM-5TDJV4Z3');</script>
<!-- End Google Tag Manager -->
...
<body>
<?php include_once("google_tags_body.php");?>
...
if($page !='inspiringgroup')
{
		...
		elseif($page=='villaform-admin' || $page=='villaform-customer')
		{
			
			echo '<script type="text/javascript" src="'.$url_link.'libs/ckeditor/ckeditor.js"></script>';
			echo '<script type="text/javascript" src="'.$url_link.'libs/ckeditor/adapters/jquery.js"></script>';	
		}
