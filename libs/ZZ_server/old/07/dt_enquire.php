        ...
        <div id="enbox"  class="enbox_xy">
            ...
            <div id="enbox2"  class="col12 enbox box   ">
                ...
                <form id="form_contact_website" class="clearfix">
                    ...
                    <input type="hidden" name="txtIP" value="<?php echo $_SERVER['REMOTE_ADDR'];?>">
                    ...
                    <div class="mg-contact-form-input col-md-6 nopad" style="padding-left:2px;"><!-- -->
                        ...
                        <input type="text" class="form-control ip required" id="checkout" name="checkout" placeholder="Check Out*" onBlur="check_price(),check_date('checkin','checkout');">
