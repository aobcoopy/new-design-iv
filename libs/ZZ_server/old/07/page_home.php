...
<div id="mega-sliders2" class="carousel slide top48 mob992" data-ride="carousel">
		...
		$ar_pp_618_alt = ['luxury villa Thailand','Thailand private villas','luxury pool villa in Thailand'];
        ...
        foreach($ar_pp_618_jpg as $m_p )
        {
           ...
           /* $ar_pp_768 = ['/upload/slide/768/yang-20201591684020.webp','upload/slide/768/vth20201591684721.webp','upload/slide/768/inspiring_villas1594905061.webp'];
            ...
            if($aq==0)
            {
				...
				$imagess = '<img class="mob992 cal_mob lazy" src="'.$m_p.'" width="618" height="203" alt="'.$ar_pp_618_alt[$aq].'">';
				/*$imagess = '<picture>';
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-8 col-md-offset-2">
                    ...
                    <h1 class="hidden-xs1 mtop255_2" >Explore Luxury Villa Thailand Private Villas For Rent</h1>
                    <h2 class="f16" style="font-family: pr !important;">Discover Luxury Villa Thailand</h2>
                    <p class="f16 top20" style="font-family: pt !important;">
                    	With an exceptional collection of luxury villa, private villas, luxury pool villa in Thailand, one can truly get away from the pressures of everyday life and escape to the tropical beauty of Southeast Asia. For a wedding, honeymoon or a family vacation, Inspiring Villas offers a complete range of luxury villa Thailand to choose from. </p>
                    
                    <h2 class="f16" style="font-family: pr !important;">A handpicked Luxury Villa Thailand collection</h2>
                    <p class="f16 top20" style="font-family: pt !important;">
                    	Privacy, exclusivity and location are what make a luxury private villas in Thailand an unforgettable experience. Each property in the Inspiring Villas collection has been personally inspected and selected for its unique style, design and potential to make an otherwise ordinary vacation exceptional. 
                    </p>
                    
                    <h2 class="f16" style="font-family: pr !important;">Personalised service</h2>
                    <p class="f16 top20" style="font-family: pt !important;">
                    	Each one of our Thailand luxury villas comes with the complete and personalised service of our incredible team. Whether you choose to visit the lush island shores of Koh Samui, the thriving beach metropolis of Phuket or the laid-back vibes in Koh Phangan, your experience will come with 100% support from a dedicated team to ensure that your holiday is nothing short of extraordinary. 
                    </p>
                    </center>
                <br>
                <div class="row">
				...
				function switchcase_alt($val)
				{
					switch($val)
					{
						...
						break;
						case "6":
							return "Beachfront Villas Thailand";//return "Beachfront Villas - Phuket, Koh Samui, Thailand";
						break;
						case "8":
	...
	<div class="row">
    	<div class="col-md-8 col-md-offset-2">
        	<center>
                ...
                <p class="f16 top20" style="font-family: pt !important;">
                    Finding the right luxury villa Thailand is key to creating the kind of experience that will be truly unforgettable. Browse our collection of luxury villas online today to find the perfect property for your dream Thailand holiday. 
                </p>
