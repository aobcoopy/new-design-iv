	...
	<div class="row">
		...
		if($llin=='/blog/blog-author.html')
		{
			$ar_tl = array(
				...
				array(
						'name' => 'Phuket Vacation Rentals',
						'link' => 'https://www.inspiringvillas.com/phuket-vacation-rentals.html',
				), 
				array(
						'name' => 'Koh Samui Vacation Rentals',
						'link' => 'https://www.inspiringvillas.com/koh-samui-vacation-rentals.html',
				), 
				array(
						'name' => 'Luxury Beachfront Pool Villas in Thailand',
						'link' => 'https://www.inspiringvillas.com/beachfront-pool-villas-in-thailand.html',
				), 
				array(
						'name' => 'The Best Pool Villas in Thailand',
						'link' => 'https://www.inspiringvillas.com/The-Best-Pool-Villas-in-Thailand.html',
				), 
				array(
						'name' => 'Luxury Beach Villas in Thailand',
						'link' => 'https://www.inspiringvillas.com/Luxury-Beach-Villas-in-Thailand.html',
				),
				array(
						'name' => 'Family Villas in Phuket',
						'link' => 'https://www.inspiringvillas.com/family-villa-phuket.html',
				), 
				array(
						'name' => 'Family Villas in Koh Samui',
						'link' => 'https://www.inspiringvillas.com/family-villa-Koh-Samui.html',
				),
				array(
						'name' => 'Best Luxury Villas in Thailand',
						'link' => 'https://www.inspiringvillas.com/Best-Luxury-Villas-in-Thailand.html',
				), 
			);
