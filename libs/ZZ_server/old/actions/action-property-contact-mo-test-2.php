<?php 
	...
	$fullname = $_REQUEST['full_name_mo'];
	$ex_name = explode(" ",$fullname);
	$userTrimFirstName = trim($ex_name[0]);
...
//			//$str_name = $fullname." Enquiry ".$villa_name;
//			//$strSubject_2 = "=?utf-8?B?".base64_encode($str_name)."?=";
//		}
//		elseif($prop['destination']=='100')
//		{
//			$strTo_2 = "bali-rsvn@inspiringvillas.com";
//			//$str_name = "Enquiry ".$villa_name;
//			//$strSubject_2 = $str_name;//"=?utf-8?B?".base64_encode($str_name)."?=";
//		}
...
//		}
		...
		$strHeader_2.= "MIME-Version: 1.0' . \r\n";
		$strHeader_2.= "From: rsvn@inspiringvillas.com";
		//$strSubject_2 = $_REQUEST['full_name_mo']." Enquiry ".$villa_name;
		
		$str_name = strtolower($userTrimFirstName)." Enquiry ".$villa_name;
		$strSubject_2 = "=?utf-8?B?".base64_encode($str_name)."?=";
		
		
		
		/*$str_name_2 = $fullname." Enquiry ".$villa_name;
		$strSubject_2 = "=?utf-8?B?".base64_encode($str_name_2)."?=";*/
				...
				<div style=\"width:100%;border-top:0px solid #CCC;margin-top: 45px;\">
					<div style=\"color: #000000;font-size:16px;\">
						<div class=\"\" style=\"border-bottom:0px solid #999;font-family: sans-serif;padding: 0px 30px;\">
							...
							$strMessage_2.= "<a href='https://www.inspiringvillas.com/email-detail-".$id_co.".html' target='_blank' ><button style='background-color: #112945;color: white;text-transform: uppercase;padding: 8px 0px 6px 0px;font-size: 12px;width: 100%;border: none; margin-top:15px; cursor:pointer;'>View Detail</button></a>";
                            $strMessage_2.= "<br><br>
                            Best Regards,<br>
                            Inspiring Villas Team
						</div>
		...
		if($prop['email']!='')
		{
			...
			$strSubject_3 = "=?utf-8?B?".base64_encode($str_name_3)."?=";
