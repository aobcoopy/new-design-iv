...
<?php } ?>        
            <ol itemscope itemtype="https://schema.org/BreadcrumbList" class="breadcrumb" class="breadcrumb" style="background: white;">
<?php
...
?>
            <li class="<?php if( $countLevel == $levelsToShow ) echo "active"; ?>"><a href="/<?php echo URL_builder(0, 'all-regions', 'all-areas', 'all-bedrooms', 'all-collections', $priceID, $sortBy, $arrayUrlVariables) ?>" title="All Villas"><?php echo "All Villas"; ?></a></li>
<?php 
...
?>
            <li itemprop="itemListElement" itemscope itemtype="https://schema.org/ListItem" class="<?php if( $countLevel == $levelsToShow ) echo "active"; ?>"><a itemtype="https://schema.org/Thing" itemprop="item" href="/<?php echo URL_builder($countryID, $destinationID, 'all-areas', 'all-bedrooms', 'all-collections', $priceID, $sortBy, $arrayUrlVariables) ?>" title="<?php echo $destination_name_slug[0] ?>"><span itemprop="name"><?php echo $destination_name_slug[0] ?></span></a><meta itemprop="position" content="<?php echo $position;?>" /></li>
<?php 
...
?>
            <li itemprop="itemListElement" itemscope itemtype="https://schema.org/ListItem" class="<?php if( $countLevel == $levelsToShow ) echo "active"; ?>"><a itemtype="https://schema.org/Thing" itemprop="item" href="/<?php echo URL_builder($countryID, $destinationID, $parentDestinationID, 'all-bedrooms', 'all-collections', $priceID, $sortBy, $arrayUrlVariables) ?>" title="<?php echo str_replace(" Beach", "", $subdestination_name_slug[0]) . ", " . $countryName ?>"><span itemprop="name"><?php echo str_replace(" Beach", "", $subdestination_name_slug[0]) ?></span></a><meta itemprop="position" content="<?php echo $position;?>" /></li>
<?php 
...
?>
            <li itemprop="itemListElement" itemscope itemtype="https://schema.org/ListItem" class="<?php if( $countLevel == $levelsToShow ) echo "active"; ?>"><a itemtype="https://schema.org/Thing" itemprop="item" href="/<?php echo URL_builder($countryID, $destinationID, $parentDestinationID, $bedroomsID, 'all-collections', $priceID, $sortBy, $arrayUrlVariables) ?>" title="<?php echo $bedrooms_name_shortName_slug[0] . " Villas in "; if( isset($subdestination_name_slug[0]) ) echo str_replace(" Beach", "", $subdestination_name_slug[0]); elseif(isset($destination_name_slug[0])) echo $destination_name_slug[0];/* else echo $countryName;*/ ?>"><span itemprop="name"><?php echo $bedrooms_name_shortName_slug[1] . " Villas "; if( isset($subdestination_name_slug[0]) ) echo str_replace(" Beach", "", $subdestination_name_slug[0]); elseif(isset($destination_name_slug[0])) echo $destination_name_slug[0]; /*else echo $countryName*/ ?></span></a><meta itemprop="position" content="<?php echo $position;?>" /></li>
<?php 
...
?>
            <li itemprop="itemListElement" itemscope itemtype="https://schema.org/ListItem" class="<?php if( $countLevel == $levelsToShow ) echo "active"; ?>"><a itemtype="https://schema.org/Thing" itemprop="item"  href="/<?php echo URL_builder($countryID, $destinationID, $parentDestinationID, $bedroomsID, $collectionID, $priceID, $sortBy, $arrayUrlVariables) ?>" title="All <?php echo collection_name_brief_slug($collectionID)[1] . " in "; if( isset($subdestination_name_slug[0]) ) echo str_replace(" Beach", "", $subdestination_name_slug[0]); elseif(isset($destination_name_slug[0])) echo $destination_name_slug[0]; /*else echo $countryName;*/ ?>"><span itemprop="name"><?php echo collection_name_brief_slug($collectionID)[1]; /*if(isset($destination_name_slug[0])) echo " in " . $destination_name_slug[0];*/ ?></span></a><meta itemprop="position" content="<?php echo $position;?>" /></li>
<?php 
...
?>
            ...
            <li itemprop="itemListElement" itemscope itemtype="https://schema.org/ListItem" class="active"><a itemtype="https://schema.org/Thing" itemprop="item" href="#"><span itemprop="name"><?php echo $numResults; ?> Results</span></a><meta itemprop="position" content="1" /></li>
<?php

        } else {
            
?>
            <li class="num"><span class="bnum">(<?php echo $numResults; ?>)</span></li> 
<?php            
...
*/        
    ...
    function check_if_ParameterRule_is_set($dbc, $arrayVariables)
    {
        ...
        $urlVariableString = explode("|", $arrayVariables['destination'])[0] . "|" . explode("|", $arrayVariables['subdestination'])[0] . "|" . explode("|", $arrayVariables['price'])[0] . "|" . explode("|", $arrayVariables['bedrooms'])[0] . "|" .explode("|", $arrayVariables['collections'])[0];
        ...
        if( $numParameterRules > 0 ){
            ...
            $dbVariableString = $region_variable . "|" . $neighborhood_variable . "|" . $price_variable . "|" . $rooms_variable . "|" .$collection_variable;
            
          
        } else $dbVariableString = $arrayUrlVariables['REGION'] . "|" . $arrayUrlVariables['NEIGHBORHOOD'] . "|" . $arrayUrlVariables['PRICE'] . "|" . $arrayUrlVariables['ROOMS'] . "|" .$arrayUrlVariables['COLLECTION'];
