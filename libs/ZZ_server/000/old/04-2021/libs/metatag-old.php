...
{
	$title_tag = "Thailand Villas | Private Vacation Rentals".$iv;//"Thailand Villas Luxury Rentals Phuket & Koh Samui ";//"Luxury Villa Rentals in Phuket & Koh Samui,Thailand";
...
elseif($ppa=='contact')
{
	$title_tag = "Contact Inspiring Villas | The Luxury Villa Specialists in Thailand".$iv;
	$meta_description = "Contact our villa holiday specialist team in Phuket & Koh Samui for the the best choice & service in luxury villas for rent in Thailand.Book with Inspiring Villas";
}
elseif($ppa=='about')
{
	$title_tag = "Private Pool Villa Holidays with Inspiring Villas in Phuket & Koh Samui";
...
elseif($ppa=='forrent')
{
	...
	else
	{
		...
		{	
				...
				{
					$destination_meta = "Thailand";
					$h1_destination = "Thailand ";
					$des_meta = "";
					$desti_meta = "";
					$desn_meta = "Thailand";
				}
				...
				else
				{
					...
					if($_REQUEST['des']=='all' && $_REQUEST['sub']=='all' && $_REQUEST['room']=='all')
					{
						...
						$title_tag = "Thailand Luxury Villa Rental".$iv;//$title_des.$coll."Villa Rentals | ".$luxury."Holiday Villas";//--------------all search
					}
				...
				if($h1_beach!='')
				{
					if($_REQUEST['sub']==75)
					{
						...
						$h1 = 'Maenam Luxury Villas for Rent';
					}
					else
					{
	...
	if(isset($_REQUEST['cate']) && $_REQUEST['cate']!=0 )
	{
		if($_REQUEST['des']=='all' && $_REQUEST['sub']=='all' && $_REQUEST['room']=='all' && $_REQUEST['cate']!=0 )
		{
			...
			{
				//wedding-villas
				$title_tag = "Thailand Wedding Villa Rentals";/*'101010'.*///"Wedding Luxury Villas in Phuket & Koh Samui";//"Wedding  Private Villa Rentals in Thailand";// - Koh Samui & Phuket";
