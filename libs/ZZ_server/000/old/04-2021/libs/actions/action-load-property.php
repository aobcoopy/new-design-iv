			...
			echo '<div class="col-xs-12 col-sm-6 col-md-4 web '.$pading_grid.' ">';//<a href="?page=blogdetail&blog='.$r_blog['id'].'">
													echo '<span  >';//------------itemscope itemtype="http://schema.org/Product"
														...
														echo '<div class="col-md-12 boxpho nopad">';
															...
															echo '<a href="/'.$row['ht_link'].'.html" target="_blank"><img  src="'.imagePath($photo[0]['img']).'" width="100%"></a>';//------------itemprop="image" 
														echo '</div>';
                                                                ...
                                                                echo '<div class="gray_mob ">';
                                                                    echo '<div class="row mg-room-fecilities">';
                                                                        echo '<div class="col-xs-12 col-sm-12 col-md-6 padleft25 padright25 t_t11">';
                                                                            echo '<h3 class=" font_mob top0"><a class="fbk" href="/'.$row['ht_link'].'.html" ><span ><strong>'.$name[0].' </strong></span></a></h3>';
										...
										if($exp_date>=$D_today || $exp_date=='0000-00-00' || $exp_date=='')
										{
															...
															//echo '<div class="col-xs-12 col-sm-12 col-md-8 web t_t33 v_details" style="margin-top:19px;">';
                                                                ...
                                                                echo '<div class="col-xs-12 col-sm-12 col-md-12 nopad t_t33">';
                                                                    echo '<div class="col-xs-12 col-sm-12 col-md-12 nopad t_t11"><h3 class="mg-avl-room-title vtitle f23_2"><span >'.$name[0].'</span></h3></div>';//'.$row['id'].'  //-------------cheange
                                                                ...
                                                                echo '<div  class="top20 tb t_t44 f18t- f17Desk- f15t " ><div class="indet"><span style="font-family:pt !important">'.base64_decode($row['short_det']).'</span></div></div>';
