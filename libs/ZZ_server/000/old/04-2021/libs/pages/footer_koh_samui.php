...
<div class="container <?php echo $show_koh_samui.' '.$f_foot;?>">
				...
				if($_SERVER['REQUEST_URI']=='/search-rent/thailand-koh-samui/all-beach/all-price/5-7-bedrooms/all-collections/all-sort.html')
				{
                    ...
                    <h2 class=" mb f30 top"><strong><?php /*?><a class="tg cdf" ><?php */?>Where are the Best 5,6,7 Bedroom Villas in Koh Samui?<?php /*?></a><?php */?></strong></h2>
    ...
    The type of villa holiday you go to for a week’s break to refresh & recharge in luxury. 
				...
				{
						?>
                     <h2 class=" mb f30"><strong><?php /*?><a class="tg cdf" ><?php */?>Discover Beachfront Villas in Koh Samui<?php /*?></a><?php */?></strong></h2>
                     <div class="col-md-12 nopad top41 f18">
                    Koh Samui is a beautiful tropical island in the southern Gulf of Thailand. Relaxed, laid back and small, everything is easy and convenient.
    ...
    Prices vary between seasons and are highest over the peak season of Christmas and New year.
                ...
                if($_REQUEST['room']=='all')
				{
					...
					{?>
                    	...
                    	<div class="col-md-12 nopad top41">
                        <h4 class=" mb f30 top"><strong><?php /*?><a class="tg cdf" ><?php */?>Koh Samui Beachfront Villas By Bedroom Numbers<?php /*?></a><?php */?></strong></h4>
                            <div class="col-md-12 nopad top21 f18">
...
All you need to do is pay for your groceries should you wish the chef to cook meals for you. But dont worry, you wont need to go shopping, that will happen whilst you are lying beside the pool. Daily breakfast is often included.
				...
				else
				{
					?>
						<div class="col-md-12 nopad top41">
                            <h4 class=" mb f30 top"><strong><?php /*?><a class="tg cdf" ><?php */?>What is included in your villa holiday<?php /*?></a><?php */?></strong></h4>
                                <div class="col-md-12 nopad top21 f18">
                                   When you rent a private villa it’s your personal accommodation for that period of time. All the villas are staffed with a villa manager, housekeeping, and nearly all include a full time chef. All have facilities such as cinema, games and fitness rooms.<br>
And their private pools of course.<br><br>
...
All you need to do is pay for your groceries should you wish the chef to cook meals for you. But dont worry, you wont need to go shopping, that will happen whilst you are lying beside the pool. Daily breakfast is often included.
                ...
                <div class="col-md-12 nopad top41">
                <h4 class=" mb f22 top"><strong><?php /*?><a class="tg cdf" ><?php */?><a class="blu" href="/search-rent/thailand-koh-samui/all-beach/all-price/5-7-bedrooms/all-collections/all-sort.html">5,6,7 bedroom villas Koh Samui</a><?php /*?></a><?php */?></strong></h4>
                    <div class="col-md-12 nopad top21 f18">
    ...
    Most have cinema room, games and fitness room as well as other amenities.
                ...
                <div class="col-md-12 nopad top41">
                <h4 class=" mb f22 top"><strong><?php /*?><a class="tg cdf" ><?php */?><a class="blu" href="/search-rent/thailand-koh-samui/all-beach/all-price/8-10-bedrooms/all-collections/all-sort.html">8,9,10 > bedroom villas Koh Samui</a><?php /*?></a><?php */?></strong></h4>
                    <div class="col-md-12 nopad top21 f18">
    ...
    These 8,9,10 > bedroom villas offer huge space with many different indoor and outdoor areas for extended groups
			   ...
			   if($_REQUEST['cate']==6)
			   {
				   ?> 
                   <div class="col-md-12 nopad top41">
                    <h4 class=" mb f30 top"><strong><?php /*?><a class="tg cdf" ><?php */?>What type of beachfront villas in Koh Samui are available for rent?<?php /*?></a><?php */?></strong></h4>
                        <div class="col-md-12 nopad top21 f18">
...
2.In the hills above are many beautiful private villas. Villas that offer privacy and panoramic views of the Gulf of Thailand. There are many <a href="/search-rent/thailand-koh-samui/all-beach/all-price/all-bedrooms/seaview-villas/all-sort.html" class="blu">seaview villas in Koh Samui</a> as most beaches on the island have hilltops behind them.
                    ...
                    <div class="col-md-12 nopad top41">
                        <h4 class=" mb f22 top"><strong><?php /*?><a class="tg cdf" ><?php */?>2.Can you organise my <a href="/search-rent/thailand-koh-samui/all-beach/all-price/all-bedrooms/wedding-villas/all-sort.html" class="blu">Koh Samui Villa Wedding</a><?php /*?></a><?php */?></strong></h4>
                        <div class="col-md-12 nopad top21 f18">
				...
				?>
                <div class="col-md-12 nopad top41">
                <h4 class=" mb f30 top"><strong><?php /*?><a class="tg cdf" ><?php */?>How to get to Koh Samui<?php /*?></a><?php */?></strong></h4>
                    <div class="col-md-12 nopad top21 f18">
                ...
                <div class="col-md-12 nopad top41">
                <h4 class=" mb f30 top"><strong><?php /*?><a class="tg cdf" ><?php */?>When to go to Koh Samui<?php /*?></a><?php */?></strong></h4>
                    <div class="col-md-12 nopad top21 f18">
            ...
            ?>
                 ...
                 <div class="col-md-12 nopad top41">
                    <h4 class=" mb f30 top"><strong><?php /*?><a class="tg cdf" ><?php */?>2019 Koh Samui Beach Villa Cost Survey<?php /*?></a><?php */?></strong></h4>
                        <div class="col-md-12 nopad top21 f18">
...
The attention to detail & service is always great here. And you are on the best swimming, sandy beach on Koh Samui.
                ...
                <div class="col-md-12 nopad top41">
                    ...
                    <div class="col-md-12 nopad top41">
                    <h4 class=" mb f30 top"><strong><?php /*?><a class="tg cdf" ><?php */?>2019 Villa Cost Survey<?php /*?></a><?php */?></strong></h4> <?php /*?>2018/ 2019 Koh Samui Luxury Villa Cost Survey
<?php */?>
                        <div class="col-md-12 nopad top21 f18">
