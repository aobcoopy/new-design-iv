...
echo '<ol class="breadcrumb" style="background: white;">';
	if($dest=='all' && $dest!='') // Thailand Villas
	{
		if($bedroom!='all')
		{
			if($collec!='0')
			{
				...
				echo '<li class=""><a href="'.$bread_link.'">Thailand </a></li>';
			...
			{
				$bread_link = "/search-rent/".destination_name_slug($dest)[1]."/".beach_bread(0)."/all-price/".bed_bread(0)."/".collection_bread(0)."/all-sort.html";
				echo '<li class=""><a href="'.$bread_link.'">Thailand</a></li>';//22
		...
		else
		{
			if($collec!='0')
			{
				...
				echo '<li><a href="'.$bread_link.'">Thailand</a></li>';//33
			...
			else
			{
				...
				echo '<li class="active"><a href="'.$bread_link.'">Thailand <span class="bnum">('.$num.')</span></a></li>';//44
			}
		}
	...
	elseif($dest!='all' && $dest!='')
	{
		if($bedroom!='all')
		{
			...
			{
				$bread_link = "/search-rent/".destination_name_slug(0)[1]."/".beach_bread(0)."/all-price/".bed_bread(0)."/".collection_bread(0)."/all-sort.html";
				echo '<li><a href="'.$bread_link.'">Thailand </a></li>';
				
				$bread_link = "/search-rent/".destination_name_slug($dest)[1]."/".beach_bread(0)."/all-price/".bed_bread(0)."/".collection_bread(0)."/all-sort.html";
				echo '<li><a href="'.$bread_link.'">'.des_bread_name($dest).' </a></li>';
				
				$bread_link = "/search-rent/".destination_name_slug($dest)[1]."/".beach_bread(0)."/all-price/".bed_bread($bedroom)."/".collection_bread(0)."/all-sort.html";
				echo '<li class="active"><a href="'.$bread_link.'">'.bed_bread_name_noall($bedroom).' '.des_bread_name($dest).' <span class="bnum">('.$num.')</span></a></li>';
			...
			{
				$bread_link = "/search-rent/".destination_name_slug(0)[1]."/".beach_bread(0)."/all-price/".bed_bread(0)."/".collection_bread(0)."/all-sort.html";
				echo '<li><a href="'.$bread_link.'">Thailand </a></li>';//66
		...
		{
			$bread_link = "/search-rent/".destination_name_slug(0)[1]."/".beach_bread(0)."/all-price/".bed_bread(0)."/".collection_bread(0)."/all-sort.html";
			echo '<li><a href="'.$bread_link.'">Thailand </a></li>';//77
...
//					echo '<li class="active"><a href="'.$bread_link.'">'.str_replace("Beach","",$beac_name[0]).' Villa '.des_bread_name($dest).' 111-1</a></li>';
				...
				else
				{
					if($collec!='0')
					{
						...
						$bread_link = "/search-rent/".destination_name_slug($dest)[1]."/".beach_bread(0)."/all-price/".bed_bread(0)."/".collection_bread($collec)."/all-sort.html";
						//echo '<li class="active"><a href="'.$bread_link.'">'.collection_bread_name_noall($collec).' '.des_bread_name($dest).'--------------------------</a></li>';
			...
			{
				$bread_link = "/search-rent/".destination_name_slug($dest)[1]."/".beach_bread(0)."/all-price/".bed_bread(0)."/".collection_bread(0)."/all-sort.html";
				echo '<li class="active"><a href="'.$bread_link.'">'.des_bread_name($dest).' <span class="bnum">('.$num.')</span></a></li>';//All Search 
			}
		}
	}
