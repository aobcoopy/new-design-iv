...
?>
	...
	<div class="container-fluid  webss padtop501  <?php echo $f_foot.' '.$f_hidden;?>">
		...
		if($show_thai == '')
		{
            ...
            <div class="container  <?php echo $show_thai;?> top70">
            
            
                <h2 class=" mb f30"><strong><a class="tg cdf" ><br><br>Discover Luxury Beach Villas Thailand</a></strong></h2>
    ...
    Then there is the housekeeping staff and your private full-time chef.
                ...
                <div class="col-md-12 nopad top41">
                <h2 class=" mb f30 top"><strong><a class="tg cdf" >Beach Villas Thailand</a></strong></h2>
                </div>
                
                <div class="col-md-12 nopad top41">
                    <h2 class=" mb f22 top"><strong><a class="tg cdf" ><a class="blu" href="/search-rent/thailand-phuket/all-beach/all-price/all-bedrooms/beachfront-villas/all-sort.html">Phuket beachfront villas for rent</a></a></strong></h2>
                    <div class="col-md-12 nopad top21 f18">
    ...
    These can be found in the hills and cliffs above the beaches.
                ...
                <div class="col-md-12 nopad top41">
                    <h2 class=" mb f22 top"><strong><a class="tg cdf" ><a class="blu" href="/search-rent/thailand-koh-samui/all-beach/all-price/all-bedrooms/beachfront-villas/all-sort.html">Koh Samui beachfront Villas</a></a></strong></h2>
                    <div class="col-md-12 nopad top21 f18">
    ...
    Quick guide - Taling Ngam & Laem Sor are not swimmable beaches.
            ...
            <h2 class=" mb f22 top"><strong><a class="tg cdf" >1. What is a beachfront villa</a></strong></h2>
             ...
             <div class="col-md-12 nopad top41">
                    <h2 class=" mb f22 top"><strong><a class="tg cdf" >1. Do villas require a minimum number of nights booking</a></strong></h2>
                    <div class="col-md-12 nopad top21 f18">
    ...
    This is typically 3 nights throughout the year although at peak and high season this can increase to 5, 7 and even 10 nights. At the bottom of our villa details pages we show the minimum nights required at the different times of the year.
                ...
                <div class="col-md-12 nopad top41">
                    <h2 class=" mb f22 top"><strong><a class="tg cdf" >2. Peak Season Travel advice</a></strong></h2>
                    <div class="col-md-12 nopad top21 f18">
    ...
    Plan ahead, if you are staying here during peak season then advance planning will reward you as often the flights are full up for long periods and it is much more expensive to travel and stay.
                ...
                <div class="col-md-12 nopad top41">
                    <h2 class=" mb f22 top"><strong><a class="tg cdf" >3. How do I book excursions for our stay</a></strong></h2>
                    <div class="col-md-12 nopad top21 f18">
                ...
                <div class="col-md-12 nopad top41">
                    <h2 class=" mb f22 top"><strong><a class="tg cdf" >4. Who does all the grocery shopping that we will need</a></strong></h2>
                    <div class="col-md-12 nopad top21 f18">
                ...
                <div class="col-md-12 nopad top41">
                    <h2 class=" mb f22 top"><strong><a class="tg cdf" >5. How are children accommodated</a></strong></h2>
                    <div class="col-md-12 nopad top21 f18">
                ...
                <div class="col-md-12 nopad top41">
                    <h2 class=" mb f22 top"><strong><a class="tg cdf" >6. What time is check-in and check-out</a></strong></h2>
                    <div class="col-md-12 nopad top21 f18">
    ...
    When you decide which villa, the Owner will hold the villa for a period of time to receive a deposit. 
                ...
                <div class="col-md-12 nopad top41">
                    <h2 class=" mb f22 top"><strong><a class="tg cdf" >8. Do I need a visa for Thailand</a></strong></h2>
                    <div class="col-md-12 nopad top21 f18">
