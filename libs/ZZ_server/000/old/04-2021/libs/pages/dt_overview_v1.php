...
<div class="pr col-md-12 nopad t_t22 minitext t5b24 hidden-xs1 f16 tb" style="line-height:1.8">
    ...
    <a class="blu" onClick="goto_price_table();">Price Range  $<?php echo $room['pmin'];?> - $<?php echo $room['pmax'];?> <span class="hidden-xs hidden-sm">/ season</span></a>
    <div class="aa" style="width: 100%;height: 12px;"></div>
    <?php
    if($nu_rate>0)
	{
...
<span  itemprop="description"  class="minitext t5b24 hidden f14">
	<span itemprop="offers" class="f14" itemscope itemtype="http://schema.org/AggregateOffer">Price Range
        ...
        -
        <span itemprop="priceCurrency" content="USD">$</span><span itemprop="highPrice" content="<?php echo $room['pmax'];?>"><?php echo $room['pmax'];?></span>
        <span itemprop="offerCount" class="hidden"><?php echo $room['pmax'];?></span>
    </span>
    / season
