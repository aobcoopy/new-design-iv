								...
								echo '<div class="row">';
									...
									echo '<div class="col-sm-6">';
                                        ...
                                        <span itemprop="offers" itemscope itemtype="http://schema.org/Offer" style="color:#f05b46;">
                                            Price Range 
                                            <span itemprop="priceCurrency" content="USD">$</span><span itemprop="price" content="<?php echo $rest['pmin'];?>"><?php echo $rest['pmin'];?></span>
                                            -
                                            <span itemprop="priceCurrency" content="USD">$</span><span itemprop="price" content="<?php echo $rest['pmax'];?>"><?php echo $rest['pmax'];?></span> / night
                                        </span>
										<?php
